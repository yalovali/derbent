package automated_tests.tech.derbent.ui.automation.tests.helpers;
...
public final class CControlSignature implements IControlSignature {
	...
	public static CControlSignature forSelector(final String signatureName, final String selector,
			final IComponentTester tester) {
		return new CControlSignature(signatureName, page -> page.locator(selector).count() > 0, tester);
	}

	public static CControlSignature forSelectorsMinMatch(final String signatureName, final List<String> selectors,
			final int minMatches, final IComponentTester tester) {
	...
	public CControlSignature(final String signatureName, final Predicate<Page> detector,
			final IComponentTester tester) {
	...
	@Override
	public IComponentTester getTester() { return tester; }
