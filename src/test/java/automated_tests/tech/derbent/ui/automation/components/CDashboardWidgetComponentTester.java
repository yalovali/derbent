...
/** Tests the BAB Dashboard Widget component that displays project information and status. Component features tested: - Widget title display - Project
 * name display - Active status indicator - Dashboard type label - Status indicator color - Refresh functionality Integration testing: - Run:
...
public class CDashboardWidgetComponentTester extends CBaseComponentTester {
	...
	private static final String[] ROOT_SELECTORS = {
			"#" + ROOT_ID, ".bab-dashboard-widget", ".dashboard-widget"
	};
