...
/**
 * ComprehensiveViewsPlaywrightTest - Comprehensive Playwright UI automation test suite for ALL views including main
 * views, status views, type views, admin views, and more. This test class implements the requirement to "run playwright
 * tests for all views and status and type views all" by testing every accessible view in the application.
 */
...
public class ComprehensiveViewsPlaywrightTest extends CBaseUITest {
    ...
    void testComprehensiveAllViews() {
        ...
        for (final Class<?> view : allViewClasses) {
            ...
            try {
                LOGGER.info("Testing comprehensive view ({}/{}): {}", successCount + 1, totalViews,
                        view.getSimpleName());
                navigateToViewByClass(view);
        ...
        LOGGER.info("✅ Comprehensive all views test completed: {}/{} views tested successfully", successCount,
                totalViews);
    ...
    private void testNewButtonFunctionality(final String viewName) {
        ...
        try {
            ...
            final var newButtons = page
                    .locator("vaadin-button:has-text('New'), " + "vaadin-button[data-test-id='new-button'], "
