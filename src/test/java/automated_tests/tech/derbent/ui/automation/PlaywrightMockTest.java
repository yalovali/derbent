...
public class PlaywrightMockTest extends CBaseUITest {
	...
	private void createAccessibilityScreenshot(final String viewName) throws Exception {
		...
		final String[] features = {
				"✓ Proper heading structure", "✓ Alt text for images", "✓ Keyboard navigation", "✓ Color contrast ratios",
	...
	private void createWorkflowScreenshot() throws Exception {
		...
		g2d.setFont(new Font("Arial", Font.PLAIN, 14));
		final String[] steps = {
				"1. Navigate to Users view", "2. Navigate to Projects view", "3. Navigate to Activities view", "4. Navigate to Meetings view",
				"5. Navigate to Decisions view", "6. Create new project", "7. Fill project form", "8. Save project"
		};
	...
	void testPlaywrightScreenshotFunctionality() {
		...
		try {
			...
			LOGGER.info("✅ Playwright screenshot functionality test completed successfully for {} views", allViewClasses.length);
	...
	void testWorkflowScreenshots() {
		...
		try {
			...
			final String[] additionalSteps = {
					"workflow-start", "workflow-new-project-form", "workflow-project-form-filled", "workflow-after-save"
			};
