...
/** 
 * CPageViewSelectorsTest - Validates CPage master view and detail view selector functionality
 * Tests the new entity type, master view class, and detail view class fields in CPageEntity
 */
...
public class CPageViewSelectorsTest extends CBaseUITest {
    ...
    private void testMasterViewClassField() {
        try {
            ...
            Locator masterViewField = getLocatorWithCheck("input[placeholder*='Master View'], vaadin-text-field", 
                "Master View Class field");
