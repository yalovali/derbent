package automated_tests.tech.derbent.ui.automation.components.helpers;
...
public abstract class CTestComponentBase_helper implements IComponentTester {
	...
	protected static final Logger LOGGER = LoggerFactory.getLogger(CTestComponentBase_helper.class);
