...
public class CWorkflowStatusValidationTest extends CBaseUITest {

	private static final Logger LOGGER = LoggerFactory.getLogger(CWorkflowStatusValidationTest.class);
