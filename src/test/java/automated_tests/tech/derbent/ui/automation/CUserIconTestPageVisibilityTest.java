...
/**
 * Test to verify that the User Icon Test page is accessible from the Test Support Page
 * and that icons display correctly on the User Icon Test page.
 * 
 * This test addresses the issue: "user icon test page doesn't show up in Test Support Page
 * and icons not show still in http://localhost:8080/user-icon-test"
 */
