...
/**
 * Real Playwright UI test for dynamically loading CUser page and testing 
 * add project relation CRUD functions.
 * 
 * This test validates:
 * 1. Dynamic loading of CUser page from database configuration
 * 2. CComponentUserProjectSettings component loads properly
 * 3. Add project relation functionality works without lazy loading errors
 * 4. Complete CRUD operations for user project assignments
 * 5. Screenshots for visual validation
 */
