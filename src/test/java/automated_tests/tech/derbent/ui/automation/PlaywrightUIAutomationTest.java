...
/**
 * PlaywrightUIAutomationTest - Comprehensive Playwright UI automation test suite. This test class provides the main
 * test methods referenced by the run-playwright-tests.sh script and implements comprehensive UI testing across all
 * application views.
 */
...
public class PlaywrightUIAutomationTest extends CBaseUITest {
    ...
    void testComprehensiveAllViewsNavigation() {
        ...
        LOGGER.info("✅ Comprehensive navigation test completed: {}/{} views accessed", successCount,
    ...
    void testInvalidLoginHandling() {
        ...
        final boolean hasError = page.locator("vaadin-notification, [role='alert'], .error").count() > 0;
    ...
    void testLogoutFunctionality() {
        ...
        performLogout();
        wait_loginscreen();
        assertTrue(page.locator(".custom-login-view").isVisible(), "Should be back at login page");
