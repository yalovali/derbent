...
/**
 * CTestUtils - Common utility functions for UI testing
 * Provides reusable functions with annotation-based approach and reduced logging.
 * Uses class metadata instead of magic strings where possible.
 */
public final class CTestUtils {
	...
	public static boolean checkAccessibility(final Page page, final String viewName) {
		try {
			...
			LOGGER.debug("Accessibility check for {}: {} headings, {} aria-labeled elements, {} buttons", 
