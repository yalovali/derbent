...
class CancelButtonConsistencyTest extends CTestBase {
	...
	void testCAbstractMDPageHasCancelButton() {
		assertDoesNotThrow(() -> {
			...
			final Method createCancelButton = CAbstractNamedEntityPage.class
				.getDeclaredMethod("createCancelButton", String.class);
			assertNotNull(createCancelButton,
				"CAbstractMDPage should have createCancelButton method");
	...
	void testCButtonHasCreateMethods() {
		assertDoesNotThrow(() -> {
			...
			// types
			final Method createPrimary =
				CButton.class.getDeclaredMethod("createPrimary", String.class);
			assertNotNull(createPrimary, "CButton should have createPrimary method");
			final Method createTertiary =
				CButton.class.getDeclaredMethod("createTertiary", String.class);
	...
	void testCDBEditDialogHasCancelButton() {
		assertDoesNotThrow(() -> {
			...
			final Method setupButtons =
				CDBEditDialog.class.getDeclaredMethod("setupButtons");
	...
	void testCDialogBaseClassExists() {
		assertDoesNotThrow(() -> {
			...
			assertNotNull(setupButtons,
				"CDialog should have abstract setupButtons method");
