...
/**
 * Test to ensure all views that extend CAbstractMDPage have cancel button functionality.
 * This test validates the requirement from the coding guidelines that all views should
 * have cancel buttons to reject changes.
 */
class CancelButtonConsistencyTest {

    @Test
    void testCAbstractMDPageHasCancelButton() {
        assertDoesNotThrow(() -> {
            // Verify that the base class has the createCancelButton method
            final Method createCancelButton = CAbstractMDPage.class.getDeclaredMethod("createCancelButton", String.class);
            assertNotNull(createCancelButton, "CAbstractMDPage should have createCancelButton method");
            
            // Verify that the base class has the createDetailsTabButtonLayout method that includes cancel
            final Method createDetailsTabButtonLayout = CAbstractMDPage.class.getDeclaredMethod("createDetailsTabButtonLayout");
            assertNotNull(createDetailsTabButtonLayout, "CAbstractMDPage should have createDetailsTabButtonLayout method");
    ...
    void testCButtonHasCreateMethods() {
        assertDoesNotThrow(() -> {
            // Verify that CButton has the static factory methods for different button types
