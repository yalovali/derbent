...
/**
 * Simple test class to verify CHierarchicalSideMenu compiles and basic structure.
 * This test validates the implementation without requiring full Vaadin context.
 */
class CHierarchicalSideMenuBasicTest {
    ...
    void testClassStructureIsValid() {
        ...
        Class<?> menuClass = CHierarchicalSideMenu.class;
    ...
    void testInnerClassesExist() {
        Class<?>[] innerClasses = CHierarchicalSideMenu.class.getDeclaredClasses();
