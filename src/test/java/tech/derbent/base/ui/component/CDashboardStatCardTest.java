...
/**
 * Unit tests for CDashboardStatCard.
 * Layer: Test (MVC)
 * Verifies the dashboard stat card component functionality.
 */
class CDashboardStatCardTest {

    @Test
    void testStatCardCreationWithString() {
        // Test creating a stat card with string value
        final CDashboardStatCard card = new CDashboardStatCard(
            "Test Metric", 
            "42", 
