...
/**
 * Test class for CHierarchicalSideMenu component.
 * Tests the menu hierarchy parsing and structure creation.
 */
...
class CHierarchicalSideMenuTest {
    ...
    /**
     * Test that demonstrates the hierarchical menu functionality.
     * This test validates that the menu can be created and contains the expected structure.
     */
    @Test
    void testMenuStructureCreation() {
        // The menu should have been built from MenuConfiguration
        // and should contain at least the basic structure components
        ...
        long childCount = hierarchicalSideMenu.getChildren().count();
    ...
    void testCSSClassesApplied() {
        ...
        String cssClasses = hierarchicalSideMenu.getElement().getAttribute("class");
