...
/**
 * Test class for CStatus base class functionality. Uses CActivityStatus as a concrete implementation for testing.
 */
class CStatusTest extends CTestBase {
    ...
    void testConstructorWithBlankName() {
        // When/Then
        assertThrows(IllegalArgumentException.class, () -> new CActivityStatus("   ", project));
    }
    ...
    void testConstructorWithNullName() {
        // When/Then
        assertThrows(IllegalArgumentException.class, () -> new CActivityStatus(null, null));
    }
