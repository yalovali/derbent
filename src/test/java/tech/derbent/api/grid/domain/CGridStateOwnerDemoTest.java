...
class CGridStateOwnerDemoTest {
	...
	/** Demo widget that implements IStateOwnerComponent. Represents a collapsible task widget with details. */
	static class TaskWidget extends Div implements IStateOwnerComponent {
		...
		public boolean isDetailsExpanded() { return detailsExpanded; }
		...
		public void setDetailsExpanded(final boolean expanded) { detailsExpanded = expanded; }

		public void setUserNote(final String note) { userNote = note; }
	}
	...
	void demonstrateCompleteWorkflow() {
		...
		final List<Task> tasks = Arrays.asList(new Task(1L, "Implement feature X", "In Progress"), new Task(2L, "Review PR #123", "Pending"),
				new Task(3L, "Fix bug in module Y", "Done"), new Task(4L, "Write documentation", "In Progress"),
