...
public class CCustomLoginViewTest extends CBaseUITest {
    ...
    void testCustomLoginFormValidation() {
        ...
        // Check for validation error (should show error message)
        // Wait a moment for the error to appear
        page.waitForTimeout(1000);
        
        // The error message should be visible
        assertTrue(page.locator("text=Please enter both username and password").isVisible());
    ...
    void testCustomLoginFormWithCredentials() {
        ...
        // Should be redirected to dashboard or main page after successful login
