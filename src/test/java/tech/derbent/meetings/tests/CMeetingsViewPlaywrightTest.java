...
/**
 * CMeetingsViewPlaywrightTest - Comprehensive Playwright tests for the Meetings view. Tests all aspects of the Meetings
...
public class CMeetingsViewPlaywrightTest extends CApplicationGeneric_UITest {
    ...
    void testMeetingsCompleteWorkflow() {
        ...
        assertTrue(navigateToViewByClass(CMeetingsView.class), "Should navigate to Activities view");
