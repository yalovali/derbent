...
/**
 * Integration test for profile picture database storage functionality. Tests the end-to-end flow of storing and
 * retrieving profile pictures from database.
 */
public class CUserProfilePictureIntegrationTest extends CTestBase {
    ...
    public void testImageProcessingFlow() throws IOException {
        ...
        assertDoesNotThrow(() -> CImageUtils.validateImageData(originalImage, "test.jpg"));
