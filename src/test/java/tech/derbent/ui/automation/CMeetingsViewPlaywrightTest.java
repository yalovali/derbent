...
public class CMeetingsViewPlaywrightTest extends CBaseUITest {
    ...
    void testMeetingsViewLoading() {
        ...
        // Login and navigate to Meetings view
        loginToApplication();
        
        // Navigate to Meetings view using navigation
        assertTrue(navigateToViewByText("Meetings"), "Should navigate to Meetings view");
    ...
    void testMeetingsNavigation() {
        ...
        if (navigateToViewByText("Projects")) {
            ...
            assertTrue(navigateToViewByText("Meetings"), "Should navigate back to Meetings view");
            wait_1000();
