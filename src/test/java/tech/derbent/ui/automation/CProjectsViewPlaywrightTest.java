...
public class CProjectsViewPlaywrightTest extends CBaseUITest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CProjectsViewPlaywrightTest.class);

    @Test
    void testProjectsViewLoading() {
        LOGGER.info("🧪 Testing Projects view loading...");
        
        // Login and navigate to Projects view
        loginToApplication();
        
        // Navigate to Projects view using navigation
        assertTrue(navigateToViewByText("Projects"), "Should navigate to Projects view");
    ...
    void testProjectsNavigation() {
        ...
        if (navigateToViewByText("Activities")) {
            ...
            assertTrue(navigateToViewByText("Projects"), "Should navigate back to Projects view");
            wait_1000();
