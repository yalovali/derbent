...
/**
 * Test class for the enhanced entity label and icon functionality.
 * Tests the new CEntityLabel component and expanded icon support.
 */
public class CEntityLabelTest {
    ...
    void testSpecificEntityIcons() {
        ...
        assertEquals(VaadinIcon.USER, CColorUtils.getIconForEntity(testUser), 
        ...
        assertEquals(VaadinIcon.FOLDER, CColorUtils.getIconForEntity(testProject), 
                    "Project should have FOLDER icon");
    }
    ...
    void testEntityClassNamePatterns() {
        ...
        assertEquals(VaadinIcon.LIST, CColorUtils.getIconForEntity(activityType), 
                    "ActivityType should get LIST icon");
    }
}