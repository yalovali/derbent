...
class CActivityKanbanDragDropTest {
    ...
    void testKanbanColumnWithDropHandler() {
        ...
        final java.util.function.Consumer<CActivity> mockHandler = mock(java.util.function.Consumer.class);
    ...
    void testKanbanBoardViewCreation() {
        ...
        final Map<CActivityStatus, List<CActivity>> groupedActivities = Map.of(
            todoStatus, List.of(testActivity)
        );
