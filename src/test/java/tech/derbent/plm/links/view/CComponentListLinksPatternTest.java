...
class CComponentListLinksPatternTest {
	...
	void testImplementsStandardInterfaces() {
		assertTrue(IContentOwner.class.isAssignableFrom(CComponentLink.class), "CComponentListLinks should implement IContentOwner");
		assertTrue(IGridComponent.class.isAssignableFrom(CComponentLink.class), "CComponentListLinks should implement IGridComponent");
		assertTrue(IGridRefreshListener.class.isAssignableFrom(CComponentLink.class), "CComponentListLinks should implement IGridRefreshListener");
