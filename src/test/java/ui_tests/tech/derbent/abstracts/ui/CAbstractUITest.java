...
/** CAbstractUITest - Base class for UI testing with common utilities and mocking patterns. Layer: Testing (MVC) Provides common test utilities for UI
...
public abstract class CAbstractUITest<EntityClass extends CEntityDB<EntityClass>> {
	...
	/** Creates a test entity with the specified ID and name. Should be overridden by subclasses to create properly initialized entities.
	...
	/** Sets up test data entities. Should be overridden by subclasses to provide specific test entities with all required relationships
	 * initialized. */
	...
	/** Tests grid column access for lazy loading issues. Verifies that all configured columns can access entity properties without lazy loading
	 * exceptions.
	...
	/** Tests grid data loading without exceptions. Simulates the grid data provider callback and verifies no lazy loading exceptions occur.
	 * @param grid the grid to test */
