package unit_tests.tech.derbent.setup.view;
...
/** Test class to verify that CEntityFormBuilder properly completes all forField bindings before readBean is called, preventing
...
class CSystemSettingsFormBindingTest extends CTestBase {
	...
	void testFormBindingWithNullBean() {
		...
		assertDoesNotThrow(() -> {
			final var binder = CBinderFactory.createBinder(CSystemSettings.class);
