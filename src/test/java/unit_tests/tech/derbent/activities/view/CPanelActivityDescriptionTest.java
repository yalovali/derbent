...
/** Test class for CPanelActivityDescription to ensure it follows the same pattern as CPanelUserDescription. Updated to use annotation-based data
 * provider resolution. */
...
class CPanelActivityDescriptionTest extends CTestBase {
	...
	@Test
	void testPopulateFormWithNullEntity() throws Exception {
		// Given
		panel = new CPanelActivityDescription(testActivity, binder, activityService);
	...
	@Test
	void testSaveEventHandler() throws Exception {
		panel = new CPanelActivityDescription(testActivity, binder, activityService);
