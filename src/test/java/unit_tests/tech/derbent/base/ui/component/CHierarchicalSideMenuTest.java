...
class CHierarchicalSideMenuTest extends CTestBase {
	...
	void testCSSClassesApplied() {
		...
		assertTrue(cssClasses.contains("hierarchical-side-menu"), "Menu should have the hierarchical-side-menu CSS class");
	...
	/** Test that demonstrates the hierarchical menu functionality. This test validates that the menu can be created and contains the expected
	 * structure. */
	@Test
