...
/**
 * Unit tests for COrder domain entity. Tests basic functionality of the order management
 * system including entity creation, field validation, and approval management.
 */
