...
/** Test class for CDataProviderResolver to verify annotation-based data provider functionality. These tests focus on the resolver's behavior with
...
class CDataProviderResolverTest extends CTestBase {
	...
	private AMetaData createAMetaData(final String beanName, final String beanValue, final Class<?> providerClass, final String methodName) {
