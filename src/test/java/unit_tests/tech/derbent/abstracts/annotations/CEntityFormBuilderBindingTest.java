...
/** Test to verify that the CEntityFormBuilder fixes for incomplete forField bindings work correctly. This specifically tests the fix for the binding
 * error: "All bindings created with forField must be completed before calling readBean" */
...
public class CEntityFormBuilderBindingTest {
	...
	public static class TestEntity {
		...
		public void setBigDecimalField(final BigDecimal bigDecimalField) { this.bigDecimalField = bigDecimalField; }

		public void setDoubleField(final Double doubleField) { this.doubleField = doubleField; }

		public void setIntField(final Integer intField) { this.intField = intField; }

		public void setLongField(final Long longField) { this.longField = longField; }

		public void setStringField(final String stringField) { this.stringField = stringField; }
	}

	/** Test that form building with various field types doesn't cause incomplete bindings. This test specifically targets the forField binding issues
	 * that were fixed. */
	@Test
