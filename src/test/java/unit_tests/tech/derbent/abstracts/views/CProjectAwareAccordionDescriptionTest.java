...
/**
 * Test class for CProjectAwareAccordionDescription to verify project change listener functionality. This test verifies
 * that panels properly register/unregister as project change listeners and refresh when project changes occur.
 */
public class CProjectAwareAccordionDescriptionTest extends CTestBase {
    ...
    private class TestProjectAwarePanel extends CProjectAwareAccordionDescription<CActivity> {
        ...
        public TestProjectAwarePanel(final CActivity entity, final CEnhancedBinder<CActivity> binder,
