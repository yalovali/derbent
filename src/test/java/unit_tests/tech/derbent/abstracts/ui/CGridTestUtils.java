...
/** CGridTestUtils - Utility class for testing grid components and data providers. Layer: Testing (MVC) Provides specialized utilities for testing
 * Vaadin Grid components including: - Data provider testing with lazy loading detection - Column access validation - Performance testing for large
 * datasets - Error handling verification */
public class CGridTestUtils {
	...
	public static <T extends CEntityDB<T>> void validateGridColumns(final Grid<T> grid, final String... expectedColumnKeys) {
