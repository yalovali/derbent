 ...
 * "when clicked inside cuserview grid, there is a readBean error"
 */
...
public class CUsersViewGridSelectionTest {
    ...
    void testGridSelectionDoesNotCauseReadBeanError() {
        assertDoesNotThrow(() -> {
            ...
            CUsersView view = new CUsersView(userService, projectService, userTypeService,
            ...
            java.lang.reflect.Method getBinder = view.getClass().getSuperclass().getSuperclass().getDeclaredMethod("getBinder");
            ...
            if (binder instanceof tech.derbent.abstracts.components.CEnhancedBinder) {
                tech.derbent.abstracts.components.CEnhancedBinder<CUser> enhancedBinder = 
                    (tech.derbent.abstracts.components.CEnhancedBinder<CUser>) binder;
