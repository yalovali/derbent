...
/**
 * Test to verify that the Application's dataInitializer handles 
 * the PostgreSQL "relation cuser does not exist" error gracefully.
 */
public class ApplicationDataInitializerErrorHandlingTest {

    @Test
    public void shouldHandleCuserTableNotExistError() throws Exception {
        // Create a mock JdbcTemplate that throws the exact error from the problem statement
        ...
        ApplicationRunner dataInitializer = app.dataInitializer(mockJdbcTemplate);
