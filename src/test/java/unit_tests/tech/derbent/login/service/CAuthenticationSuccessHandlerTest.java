...
/**
 * Unit tests for CAuthenticationSuccessHandler.
 * Tests the post-login redirection logic including redirect parameter,
 * session storage, and system settings integration.
 */
