 ...
 * and validation. Follows coding guidelines by using proper logging, validation,
...
public final class CImageUtils {
	...
	public static byte[] resizeImage(final byte[] imageData, final int targetWidth,
		...
		try {
			...
			final BufferedImage resizedImage = new BufferedImage(targetWidth, targetHeight,
