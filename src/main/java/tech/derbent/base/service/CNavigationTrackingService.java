...
/**
 * Service to track navigation and update the last visited page in system settings.
 * This service listens to navigation events and stores the current route as the last visited page.
 */
@Service
