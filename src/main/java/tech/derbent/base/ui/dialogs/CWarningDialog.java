...
/**
 * CWarningDialog - Dialog for displaying warning messages to users. Layer: View (MVC) Used when an action cannot be
 * performed due to missing prerequisites or invalid state.
 */
