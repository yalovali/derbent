...
/**
 * CDashboardView - System summary dashboard that serves as the default landing page.
 * Layer: View (MVC)
...
public final class CDashboardView extends CAbstractPage {
    ...
    private void createSummaryCards() {
        ...
        totalProjectsCard = new CDashboardStatCard(
            "Total Projects", 
            "0", 
            VaadinIcon.BRIEFCASE.create()
        );
        
        totalUsersCard = new CDashboardStatCard(
            "Total Users", 
            "0", 
            VaadinIcon.USERS.create()
        );
        
        totalActivitiesCard = new CDashboardStatCard(
            "Total Activities", 
            "0", 
    ...
    private HorizontalLayout createProjectDetailRow(final String projectName, final long userCount, 
        ...
        final CDashboardStatCard projectCard = new CDashboardStatCard(
            projectName, 
            "Project", 
            VaadinIcon.FOLDER_O.create()
        );
        
        final CDashboardStatCard usersCard = new CDashboardStatCard(
            "Users", 
            userCount, 
            VaadinIcon.USER.create()
        );
        
        final CDashboardStatCard activitiesCard = new CDashboardStatCard(
            "Activities", 
            activityCount, 
