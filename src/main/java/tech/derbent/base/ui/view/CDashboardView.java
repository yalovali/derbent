...
import tech.derbent.base.ui.component.CDashboardStatCard;
import tech.derbent.projects.domain.CProject;
import tech.derbent.projects.service.CProjectService;
import tech.derbent.users.service.CUserService;

/**
 * CDashboardView - System summary dashboard that serves as the default landing page. Layer: View (MVC) Displays key
 * system metrics including total projects, users per project, and activities per project. This view responds to the
 * default route ("") and provides an overview of the application state.
 */
@Route("home")
@PageTitle("Dashboard")
...
public final class CDashboardView extends CAbstractPage {
     ...
     *            the project service for fetching project data
     * @param userService
     *            the user service for fetching user counts
     * @param activityService
     *            the activity service for fetching activity counts
     */
    ...
    /**
     * Initialize dashboard data after all dependencies are injected. This method is called after the constructor and
    ...
    private void refreshDashboardData() {
        ...
        try {
            ...
            LOGGER.info("Dashboard data refreshed successfully - Projects: {}, Users: {}, Activities: {}",
                    totalProjects, totalUsers, totalActivities);
     ...
     *            map of project names to their metrics
     */
     ...
     */
    private HorizontalLayout createProjectDetailRow(final String projectName, final long userCount,
            final long activityCount) {

        final CDashboardStatCard projectCard = new CDashboardStatCard(projectName, "Project",
        ...
        final CDashboardStatCard activitiesCard = new CDashboardStatCard("Activities", activityCount,
