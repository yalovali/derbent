...
public class CSampleDataInitializer {
	...
	private void initializePageEntities(final CProject project) {
		try {
			...
			projectOverview.setContent("<h2>Project Objectives</h2>"
					...
					+ "<h3>Key Milestones</h3>" + "<ul>" + "<li>Requirements Analysis - Completed</li>" + "<li>System Design - In Progress</li>"
					+ "<li>Development Phase - Planned</li>" + "<li>Testing & Deployment - Planned</li>" + "</ul>");
			...
			teamDirectory.setContent("<h2>Project Team</h2>"
					+ "<p>Our dedicated project team brings together diverse expertise to ensure project success.</p>" + "<h3>Core Team Members</h3>"
					+ "<div style='margin: 20px 0;'>" + "<h4>Project Manager</h4>" + "<p><strong>Mehmet Karadeniz</strong><br>"
					+ "Email: mkaradeniz@derbent.tech<br>" + "Role: Overall project coordination and stakeholder management</p>"
					+ "<h4>Lead Developer</h4>" + "<p><strong>Muhammed Şahin</strong><br>" + "Email: msahin@derbent.tech<br>"
					+ "Role: Technical leadership and architecture design</p>" + "<h4>System Analyst</h4>" + "<p><strong>Can Özdemir</strong><br>"
					+ "Email: cozdemir@derbent.tech<br>" + "Role: Requirements analysis and system design</p>" + "</div>"
			...
			resourceLibrary.setContent("<h2>Project Resources</h2>"
					+ "<p>Access all project-related documents, templates, and reference materials from this central library.</p>"
					+ "<h3>Document Categories</h3>" + "<div style='margin: 20px 0;'>" + "<h4>📋 Project Documentation</h4>" + "<ul>"
					+ "<li>Project Charter and Scope Document</li>" + "<li>Requirements Specification</li>"
					+ "<li>Technical Architecture Document</li>" + "<li>Risk Assessment and Mitigation Plan</li>" + "</ul>" + "<h4>📝 Templates</h4>"
					+ "<ul>" + "<li>Meeting Minutes Template</li>" + "<li>Status Report Template</li>" + "<li>Change Request Form</li>"
					+ "<li>Testing Documentation Template</li>" + "</ul>" + "<h4>📚 Reference Materials</h4>" + "<ul>"
					+ "<li>Technical Standards and Guidelines</li>" + "<li>Best Practices Documentation</li>" + "<li>External API Documentation</li>"
					+ "<li>Coding Standards and Conventions</li>" + "</ul>" + "<h4>🔧 Tools and Utilities</h4>" + "<ul>"
					+ "<li>Development Environment Setup Guide</li>" + "<li>Deployment Scripts and Procedures</li>"
					+ "<li>Testing Tools and Configurations</li>" + "<li>Project Management Tool Access</li>" + "</ul>" + "</div>"
