...
public class CSampleDataInitializer implements ApplicationRunner {
    ...
    private void createSampleScreens() {
        ...
        try {
            ...
            if (project1 != null) {
                createScreenWithFields(project1, "User Management Screen", "CUser", "User Name", "name", "User Email",
                        "email");
            }

            if (project2 != null) {
                createScreenWithFields(project2, "Activity Tracking Screen", "CActivity", "Activity Title", "name",
                        "Activity Status", "status");
            }

            if (project3 != null) {
                createScreenWithFields(project3, "Project Overview Screen", "CProject", "Project Name", "name",
                        "Project Description", "description");
            }

            if (project4 != null) {
                createScreenWithFields(project4, "Meeting Management Screen", "CMeeting", "Meeting Title", "name",
    ...
    private void createScreenWithFields(final CProject project, final String screenName, final String entityType,
            final String field1Caption, final String field1Name, final String field2Caption, final String field2Name) {
        // Create the screen
        ...
        field1.setFieldClass("CActivity");
        ...
        field2.setFieldClass("CActivity");
