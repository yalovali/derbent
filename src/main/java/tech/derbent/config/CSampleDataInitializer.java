...
public class CSampleDataInitializer implements ApplicationRunner {
	...
	private void createScreenWithFields(final CProject project, final String screenName,
		final String entityType, final String fieldClass, final String entityProperty1,
		final String entityProperty2) {
		// Create the screen
		...
		LOGGER.info("Created sample screen: {} for project: {}", screenName,
			project.getName());
		// Create first field
		final CScreenLines field1 =
			screenLinesService.newEntity(savedScreen, fieldClass, entityProperty1);
		...
		// Create second field
		final CScreenLines field2 =
			screenLinesService.newEntity(savedScreen, fieldClass, entityProperty2);
