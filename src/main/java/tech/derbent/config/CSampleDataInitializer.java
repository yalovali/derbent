...
public class CSampleDataInitializer implements ApplicationRunner {
	...
	private void createSampleScreens() {
		...
		try {
			...
			final CProject project4 =
				findProjectByName("Customer Experience Enhancement");
	...
	private void createScreenWithFields(final CProject project, final String screenName,
		final String entityType, final String field1Caption, final String field1Name,
		final String field2Caption, final String field2Name) {
		// Create the screen
		...
		final CScreenLines field1 =
			screenLinesService.newEntity(savedScreen, field1Caption, field1Name);
		...
		final CScreenLines field2 =
			screenLinesService.newEntity(savedScreen, field2Caption, field2Name);
