 ...
 * Layer: View (MVC) Provides common functionality for project entity panels following the
...
public abstract class CPanelProjectBase extends CAccordionDescription<CProject> {
	...
	protected void createPanelContent() {
		...
		getBaseLayout().add(
			CEntityFormBuilder.buildForm(CProject.class, getBinder(), getEntityFields()));
	}
}