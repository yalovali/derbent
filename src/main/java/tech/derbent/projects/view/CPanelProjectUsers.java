...
/** Simplified panel for managing users within a project. This is the reverse direction of CPanelUserProjectSettings - instead of showing which
 * projects a user has access to, this shows which users have access to a specific project and allows management of their roles/permissions. Key
...
public class CPanelProjectUsers extends CPanelUserProjectBase<CProject, CUserProjectSettings> {
	...
	protected String createDeleteConfirmationMessage(final CUserProjectSettings selected) {
		final String userName = selected.getUser() != null
				...
				: "Unknown User";
		return String.format("Are you sure you want to remove user '%s' from this project? This action cannot be undone.", userName);
	}
	...
	public void setCurrentProject(final CProject project) { this.currentProject = project; }
