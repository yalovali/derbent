...
/**
 * Service class for managing user-company relationships with ownership capabilities.
 * Handles CRUD operations for CUserCompanySettings entities and provides
 * business logic for company membership management.
 */
@Service
...
public class CUserCompanySettingsService extends CAbstractEntityRelationService<CUserCompanySettings> {
    ...
    @Autowired
    public CUserCompanySettingsService(final CUserCompanySettingsRepository repository, 
                                      final Clock clock, 
    ...
    @Transactional
    public CUserCompanySettings addUserToCompany(final CUser user, 
                                                final CCompany company, 
                                                final String ownershipLevel, 
                                                final String role) {
    ...
    @Transactional
    public CUserCompanySettings updateUserCompanyRole(final CUser user, 
                                                     final CCompany company, 
                                                     final String ownershipLevel, 
                                                     final String role,
                                                     final String department) {
    ...
    public List<CUserCompanySettings> findAdminCompanies(final CUser user) {
        ...
        return allSettings.stream()
            .filter(CUserCompanySettings::isCompanyAdmin)
            .toList();
    }
    ...
    @Override
    protected Class<CUserCompanySettings> getEntityClass() { 
        return CUserCompanySettings.class; 
    }
