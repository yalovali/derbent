...
/**
 * CUserTypeService - Service layer for CUserType entity. Layer: Service (MVC) Handles business logic for project-aware
...
public class CUserTypeService extends CEntityOfProjectService<CUserType> {
    ...
    /**
     * Gets a user type by ID with eagerly loaded relationships. Overrides parent get() method to prevent
    ...
    @Override
    protected Class<CUserType> getEntityClass() {
