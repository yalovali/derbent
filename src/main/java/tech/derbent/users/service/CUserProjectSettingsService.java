...
public class CUserProjectSettingsService extends CAbstractEntityRelationService<CUserProjectSettings> {
    ...
    protected CUserProjectSettings createRelationshipInstance(final Long userId, final Long projectId) {
        ...
        // Note: In a real implementation, you would fetch the actual entities from their services
        // This method should not be used directly - instead use the service methods that accept entities
    ...
    public CUserProjectSettings addUserToProject(final CUser user, final CProject project, 
        ...
        LOGGER.debug("Adding user {} to project {} with role {} and permission {}", 
                user, project, role, permission);
     ...
     */
    @Transactional
    public CUserProjectSettings updateUserProjectRole(final CUser user, final CProject project,
            final String role, final String permission) {
        LOGGER.debug("Updating user {} project {} role to {} and permission to {}", 
                user, project, role, permission);
