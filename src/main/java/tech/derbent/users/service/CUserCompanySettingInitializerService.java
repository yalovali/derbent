...
/** Initializes UI configuration for {@link CUserCompanySetting}. Creates default grid and detail
 * views to manage company memberships. */
public final class CUserCompanySettingInitializerService extends CInitializerServiceBase {
        ...
        public static CDetailSection createBasicView(final CProject project) {
                ...
                try {
                        ...
                        detailSection
                                        .addScreenLine(CDetailLinesService.createLineFromDefaults(ENTITY_CLASS, "grantedByUserId"));
        ...
        public static CGridEntity createGridEntity(final CProject project) {
                ...
                grid.setSelectedFields(
                                "id,user,company,role,ownershipLevel,privileges,isActive,grantedByUserId");
                return grid;
        }
        ...
        public static void initialize(final CProject project, final CGridEntityService gridEntityService,
                ...
                initBase(ENTITY_CLASS, project, gridEntityService, detailSectionService, pageEntityService, detailSection, grid,
                                "Relations.Company Memberships", "Company Membership Management",
                                "Manage user memberships and roles within companies", showInQuickToolbar);
        }
}
