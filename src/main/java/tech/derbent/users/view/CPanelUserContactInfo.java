...
/**
 * CPanelUserContactInfo - Panel for grouping contact information fields of CUser entity.
 * Layer: View (MVC) Groups fields: email, phone
 */
public class CPanelUserContactInfo extends CPanelUserBase {
	...
	public CPanelUserContactInfo(final CUser currentEntity,
		...
		final CCompanyService companyService) throws NoSuchMethodException,
