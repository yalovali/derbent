...
/**
 * Dialog for managing user-project assignments from the user perspective. This dialog
 * handles both creating new project assignments and editing existing ones. It allows
 * users to be assigned to projects with specific roles and permissions. Inherits common
 * relationship management logic from CDBRelationDialog.
 */
public class CUserProjectSettingsDialog
	extends CDBRelationDialog<CUserProjectSettings, CUser, CProject> {
	 ...
	 */
	public CUserProjectSettingsDialog(final CUserService masterService,
		final CProjectService detailService, final CUserProjectSettings settings,
		final CUser user, final Consumer<CUserProjectSettings> onSave) {
		super(settings != null ? settings : new CUserProjectSettings(), user,
	...
	@Override
	protected String getRelatedEntitySelectionLabel() { return "Project"; }
	...
	protected void populateEntityField() {
		final CProject project = getRelatedEntityFromRelationship(data);
