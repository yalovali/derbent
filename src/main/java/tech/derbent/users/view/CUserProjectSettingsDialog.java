...
public class CUserProjectSettingsDialog extends CDBEditDialog<CUserProjectSettings> {
	...
	public CUserProjectSettingsDialog(final CProjectService projectService,
		final CUserProjectSettings settings, final CUser user,
	...
	protected void populateForm() {
		...
		if ((projectService == null) || (user == null)) {
			throw new IllegalStateException(
				"ProjectService and User must be initialized before populating form");
		}
		// Project selection
		...
		if (!isNew) {
			...
			if (data.getProjectId() != null) {
				projectService.getById(data.getProjectId())
