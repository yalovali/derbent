...
/**
 * Simplified panel for managing a user's project assignments. This panel displays all projects assigned to a specific
 * user and allows: - Adding new project assignments - Editing existing project roles/permissions - Removing project
 * assignments The panel automatically updates when the current user changes and maintains data consistency through
 * proper accessor patterns.
 */
public class CPanelUserProjectSettings extends CPanelUserProjectBase<CUser, CUserProjectSettings> {
    ...
    public CPanelUserProjectSettings(final CUser currentEntity, final CEnhancedBinder<CUser> beanValidationBinder,
        ...
        super("Project Settings", currentEntity, beanValidationBinder, CUser.class, entityService,
    ...
    protected void openAddDialog() {
        ...
        final CUserProjectSettingsDialog dialog = new CUserProjectSettingsDialog((CUserService) entityService,
