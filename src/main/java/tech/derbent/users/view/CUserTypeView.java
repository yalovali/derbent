...
/**
 * CUserTypeView - View for managing user types.
 * Layer: View (MVC)
 * Provides CRUD operations for user types using the abstract master-detail pattern.
 */
@Route("user-types/:user_type_id?/:action?(edit)")
@PageTitle("User Types")
@Menu(order = 1, icon = "vaadin:user", title = "Settings.User Types")
@PermitAll
