...
/**
 * CPanelUserBase - Abstract base class for all CUser-related accordion panels. Layer: View (MVC) Provides common
 * functionality for user entity panels following the same pattern as CPanelActivityBase.
 */
public abstract class CPanelUserBase extends CAccordionDBEntity<CUser> {
    ...
    protected void createPanelContent() {
        getBaseLayout().add(
                CEntityFormBuilder.buildForm(CUser.class, getBinder(), getDetailsDataProvider(), getEntityFields()));
    }
}