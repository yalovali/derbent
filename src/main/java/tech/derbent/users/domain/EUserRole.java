...
/** CUserRole - Enumeration representing user roles within the system. Layer: Domain (MVC) Defines the different roles that users can have in the
 * application. */
public enum EUserRole {
	...
	public static EUserRole fromString(final String roleString) {
		...
		try {
			...
			for (final EUserRole role : values()) {
	...
	EUserRole(final String displayName, final String description) {
