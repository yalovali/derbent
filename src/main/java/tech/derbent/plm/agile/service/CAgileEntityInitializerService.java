 ...
 * </p>
 */
public final class CAgileEntityInitializerService extends CProjectItemInitializerService {
	...
	public static void addDefaultChildrenSection(final CDetailSection detailSection, final Class<?> entityClass,
		...
		try {
			...
			detailSection
					.addScreenLine(CDetailLinesService.createLineFromDefaults(entityClass, FIELD_NAME_AGILE_CHILDREN));
