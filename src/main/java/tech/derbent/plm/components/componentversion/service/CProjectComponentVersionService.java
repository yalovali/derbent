...
@PermitAll
public class CProjectComponentVersionService extends CProjectItemService<CProjectComponentVersion, CProjectComponentVersionType> implements IEntityRegistrable, IEntityWithView {
	...
	/** Copy CProjectComponentVersion-specific fields from source to target entity. Uses direct setter/getter calls for clarity.
	 * @param source  the source entity to copy from
	 * @param target  the target entity to copy to
	 * @param options clone options controlling what fields to copy */
	@Override
	public void copyEntityFieldsTo(final CProjectComponentVersion source, final CEntityDB<?> target, final CCloneOptions options) {
		super.copyEntityFieldsTo(source, target, options);
		if (!(target instanceof CProjectComponentVersion targetVersion)) {
			return;
		}
		// Copy basic fields
