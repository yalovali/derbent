...
@PermitAll
public class CProjectComponentService extends CProjectItemService<CProjectComponent, CProjectComponentType> implements IEntityRegistrable, IEntityWithView {
