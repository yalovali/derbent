...
public class CProjectComponentInitializerService extends CProjectItemInitializerService {
	...
	private static final String menuTitle = MenuTitle_PRODUCTS + ".Components";
