...
public class CProjectComponentVersionTypeInitializerService extends CEntityTypeInitializerService {
	...
	private static final String menuTitle =
			MenuTitle_TYPES + "." + MenuTitle_TYPES_PRODUCTS + ".Component Version Types";
