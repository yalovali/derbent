...
public class CProductVersionInitializerService extends CProjectItemInitializerService {
	...
	public static CGridEntity createGridEntity(final CProject<?> project) {
		...
		grid.setColumnFields(List.of("id", "product", "name", "description", "status", "project", "assignedTo",
