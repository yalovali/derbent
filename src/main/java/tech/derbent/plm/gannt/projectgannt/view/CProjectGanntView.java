package tech.derbent.plm.gannt.projectgannt.view;
...
import tech.derbent.plm.gannt.ganntviewentity.view.CGridViewBaseGannt;
import tech.derbent.plm.gannt.projectgannt.service.CPageServiceProjectGannt;
import tech.derbent.plm.meetings.service.CMeetingService;
import tech.derbent.api.page.service.CPageEntityService;
import tech.derbent.base.session.service.ISessionService;
import tech.derbent.plm.gannt.projectgannt.view.CProjectGanntView;


@Route ("cprojectganntview")
@PageTitle ("Project Gannt View")
@Menu (order = 3.1001, icon = "class:tech.derbent.plm.gannt.projectgannt.view.CProjectGanntView", title = "Project.Project Gannt Chart")
@PermitAll
