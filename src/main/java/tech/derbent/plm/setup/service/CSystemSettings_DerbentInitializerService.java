...
/**
 * CSystemSettings_DerbentInitializerService - Derbent PLM system settings initializer service.
 * Layer: Service (MVC)
 * Active when: default profile or 'derbent' profile (NOT 'bab' profile)
 * 
 * Provides initialization and setup for comprehensive PLM system settings configuration interface.
 */
public final class CSystemSettings_DerbentInitializerService extends CInitializerServiceBase {
    ...
    public static void initialize(final CProject<?> project, final CGridEntityService gridEntityService,
        ...
        LOGGER.info("Initializing Derbent PLM system settings");
    ...
    private static CGridEntity createGridEntity(final CProject<?> project) throws Exception {
        ...
        grid.setColumnFields(List.of("applicationName", "applicationVersion", "enableProjectTemplates", 
                                   "enableAdvancedReporting", "maintenanceModeEnabled", "lastModified"));
