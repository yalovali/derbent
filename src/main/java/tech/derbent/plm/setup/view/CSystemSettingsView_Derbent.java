...
/** CSystemSettingsView_Derbent - View for Derbent PLM system configuration. Layer: View (MVC) Active when: default profile or 'derbent' profile (NOT
 * 'bab' profile) Provides comprehensive configuration interface for full-featured PLM environments. Follows Derbent pattern: Concrete class marked
 * final. */
...
public final class CSystemSettingsView_Derbent extends CAbstractPage {
	...
	public CSystemSettingsView_Derbent(final CSystemSettings_DerbentService systemSettingsService, final ISessionService sessionService) {
		this.systemSettingsService = systemSettingsService;
		this.sessionService = sessionService;
		binder = CBinderFactory.createBinder(CSystemSettings_Derbent.class);
	...
	private void createHeaderSection() {
		...
		final var description = new Paragraph("Configure comprehensive system settings for project lifecycle management. "
	...
	@Override
	public String getPageTitle() { return "Derbent System Setup & Configuration"; }
