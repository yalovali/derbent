...
public class CRequirementImportHandler extends CProjectItemImportHandler<CRequirement, CRequirementType> {
	...
	public CRequirementImportHandler(final CRequirementService requirementService,
	...
	@Override
	protected void applyExtraFields(final CRequirement entity, final CExcelRow row, final CProject<?> project,
