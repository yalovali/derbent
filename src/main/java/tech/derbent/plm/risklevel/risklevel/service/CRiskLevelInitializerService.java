...
public class CRiskLevelInitializerService extends CProjectItemInitializerService {
	...
	public static CGridEntity createGridEntity(final CProject<?> project) {
		...
		grid.setColumnFields(List.of("id", "name", "description", "riskLevel", "status", "project", "assignedTo",
