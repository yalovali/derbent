package tech.derbent.plm.customers.customer.domain;
...
public class CCustomer extends CProjectItem<CCustomer> implements IHasStatusAndWorkflow<CCustomer>, IHasAttachments, IHasComments {
	...
	/** Gets the end date for Gantt chart display. For customers, this is the last interaction date. If no interaction has been recorded, returns the
	 * relationship start date to show an ongoing relationship.
	...
	@Override
	public LocalDate getStartDate() { return relationshipStartDate; }
