...
public class CProjectIncomeTypeService extends CTypeEntityService<CProjectIncomeType> implements IEntityRegistrable, IEntityWithView {
	...
	public String checkDeleteAllowed(final CProjectIncomeType entity) {
		...
		try {
			...
			LOGGER.error("Error checking dependencies for projectincome type: {} reason={}", entity.getName(), e.getMessage());
	...
	public void initializeNewEntity(final Object entity) {
		...
		final String autoName = "ProjectIncomeType %02d".formatted(typeCount + 1);
	...
	protected void validateEntity(final CProjectIncomeType entity) {
		...
		validateUniqueNameInCompany((IProjectIncomeTypeRepository) repository, entity, entity.getName(), entity.getCompany());
	}
}
