...
public class CTicketTypeService extends CTypeEntityService<CTicketType> implements IEntityRegistrable, IEntityWithView {
	...
	public String checkDeleteAllowed(final CTicketType entity) {
		...
		try {
			...
			LOGGER.error("Error checking dependencies for ticket type: {} reason={}", entity.getName(), e.getMessage());
	...
	public void initializeNewEntity(final Object entity) {
		...
		final String autoName = "TicketType %02d".formatted(typeCount + 1);
	...
	protected void validateEntity(final CTicketType entity) {
		...
		validateUniqueNameInCompany((ITicketTypeRepository) repository, entity, entity.getName(), entity.getCompany());
	}
}
