...
public class CTicketServiceDepartmentInitializerService extends CEntityOfCompanyInitializerService {
	...
	public static CGridEntity createGridEntity(final CProject<?> project) {
		...
		grid.setColumnFields(List.of("id", "name", "company", "departmentManager", "active", "emailNotificationEnabled",
