...
public class CStorageItemTypeInitializerService extends CInitializerServiceBase {

    private static final Class<?> clazz = CStorageItemType.class;
    ...
    private static final String pageDescription = "Manage storage item type categories (consumables, tools, materials)";
    private static final String pageTitle = "StorageItemType Management";
    ...
    public static CDetailSection createBasicView(final CProject<?> project) throws Exception {
        ...
        try {
            ...
            LOGGER.error("Error creating storage item type view.");
            throw e;
        }
    }
    ...
    public static void initializeSample(final CProject<?> project, final boolean minimal) throws Exception {
        final String[][] nameAndDescriptions = {
                { "Office Supplies", "Pens, paper, folders, and general office consumables" },
                { "Cleaning Supplies", "Detergents, sanitizers, and cleaning materials" },
                { "Safety Equipment", "PPE, first aid supplies, safety gear" },
                { "IT Consumables", "Cables, toners, batteries, storage media" },
                { "Maintenance Supplies", "Tools, lubricants, spare parts" },
