...
public class CStorageTypeInitializerService extends CInitializerServiceBase {

    private static final Class<?> clazz = CStorageType.class;
    ...
    private static final String pageDescription = "Manage storage type categories (warehouse, room, cabinet, bin)";
    private static final String pageTitle = "StorageType Management";
    ...
    public static CDetailSection createBasicView(final CProject<?> project) throws Exception {
        ...
        try {
            ...
            LOGGER.error("Error creating storage type view.");
            throw e;
        }
    }
    ...
    public static void initializeSample(final CProject<?> project, final boolean minimal) throws Exception {
        final String[][] nameAndDescriptions = {
                { "Warehouse", "Main storage warehouse facility" },
                { "Room", "Storage room within a facility" },
                { "Cabinet", "Storage cabinet or locker" },
                { "Bin", "Small storage bin or container" },
                { "Shelf", "Shelf unit for organized storage" }
        };
