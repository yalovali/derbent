...
public class CStorageTypeService extends CTypeEntityService<CStorageType> implements IEntityRegistrable, IEntityWithView {
	...
	public String checkDeleteAllowed(final CStorageType entity) {
		...
		try {
			...
			LOGGER.error("Error checking dependencies for storage type: {} reason={}", entity.getName(), e.getMessage());
	...
	public void initializeNewEntity(final Object entity) {
		...
		final String autoName = "StorageType %02d".formatted(typeCount + 1);
	...
	protected void validateEntity(final CStorageType entity) {
		...
		validateUniqueNameInCompany((IStorageTypeRepository) repository, entity, entity.getName(), entity.getCompany());
	}
}
