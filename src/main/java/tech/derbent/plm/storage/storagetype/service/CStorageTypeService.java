...
public class CStorageTypeService extends CTypeEntityService<CStorageType> implements IEntityRegistrable, IEntityWithView {
    ...
    public CStorageTypeService(
            final IStorageTypeRepository repository,
            final Clock clock,
    ...
    public String checkDeleteAllowed(final CStorageType entity) {
        ...
        try {
            ...
            if (usageCount > 0) {
                return String.format("Cannot delete. It is being used by %d storage location%s.", usageCount,
                        usageCount == 1 ? "" : "s");
            }
            return null;
    ...
    @Override
    public Class<CStorageType> getEntityClass() {
        return CStorageType.class;
    }

    @Override
    public Class<?> getInitializerServiceClass() {
        return CStorageTypeInitializerService.class;
    }

    @Override
    public Class<?> getPageServiceClass() {
        return CPageServiceStorageType.class;
    }
