package tech.derbent.app.validation.validationsession.view;
...
import tech.derbent.app.validation.validationsession.service.CValidationSessionService;
...
public class CComponentValidationExecution extends CVerticalLayout
	...
	private void createTestCard() {
		...
		buttonPass = new CButton("PASS", passIcon, e -> on_result_clicked(CValidationResult.PASSED));
		...
		buttonFail = new CButton("FAIL", failIcon, e -> on_result_clicked(CValidationResult.FAILED));
		...
		buttonSkip = new CButton("SKIP", skipIcon, e -> on_result_clicked(CValidationResult.SKIPPED));
		...
		buttonBlock = new CButton("BLOCK", blockIcon, e -> on_result_clicked(CValidationResult.BLOCKED));
