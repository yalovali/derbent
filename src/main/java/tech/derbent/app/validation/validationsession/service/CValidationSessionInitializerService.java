...
private static final String pageDescription = "Validation execution tracking and results";
	...
	public static CGridEntity createGridEntity(final CProject project) {
		...
		grid.setColumnFields(List.of("id", "name", "validationSuite", "result", "executedBy", "executionStart",
				"executionEnd", "durationMs", "totalValidationCases", "passedValidationCases", "failedValidationCases", "project", "createdDate"));
		return grid;
	}
	...
	public static void initializeSample(final CProject project, final boolean minimal) throws Exception {
		final CValidationSessionService validationSessionService = (CValidationSessionService) CSpringContext.getBean(CEntityRegistry.getServiceClassForEntity(clazz));
		...
		initializeProjectEntity(nameAndDescriptions,
				...
				(item, index) -> {
					...
					validationSession.setFailedValidationSteps(validationSession.getTotalValidationSteps() - validationSession.getPassedValidationSteps());
