...
/**
 * CGanttItem - Data transfer object for Gantt chart representation of project
 * items. This class wraps project items (CActivity, CMeeting, CDecision,
 * COrder) to provide a unified interface for Gantt chart display. Follows
 * coding standards with C prefix and provides standardized access to entity
...
public class CGanntItem extends CEntityOfProject<CGanntItem> {
    ...
    static public CProjectItem<?> getGanntItemById(Long id, CProjectItem<?> selectedItem,
            final CEntityOfProjectService<?> activityService,
    ...
    /**
     * Constructor for CGanttItem with explicit ID to avoid collisions across
     * different entity types.
     * 
     * @param entity   The project item to wrap
     * @param uniqueId Unique ID for this CGanttItem (sequential counter to prevent
     *                 Activity ID=1 and Meeting ID=1 collision)
     */
    ...
    /**
     * Get the entity color code for visual representation using interface or
    ...
    @SuppressWarnings("null")
    public CProjectItem<?> getGanntItem(final CEntityOfProjectService<?> activityService,
            final CEntityOfProjectService<?> meetingService) {
        CEntityOfProjectService<?> service = null;
