...
/**
 * CDialogAttachmentUpload - Dialog for uploading attachments.
 * 
 * Provides a user-friendly interface for uploading files with:
 * - Drag and drop support
 * - Document type selection
 * - Optional description
 * - Optional version number (manual entry)
...
public class CDialogAttachmentUpload extends CDialog {
	...
	private ComboBox<CDocumentType> comboDocumentType;
	 ...
	 * @param documentTypeService the document type service
	...
	public CDialogAttachmentUpload(final CAttachmentService attachmentService,
			...
			final Consumer<CAttachment> onUploadSuccess) {
		super();
	...
	protected void setupContent() throws Exception {
		...
		// Document type selection
		comboDocumentType = new ComboBox<>("Document Type");
		comboDocumentType.setWidthFull();
		comboDocumentType.setItemLabelGenerator(CDocumentType::getName);
		comboDocumentType.setItems(documentTypeService.findAll());
		comboDocumentType.setPlaceholder("Select document type (optional)");
		content.add(comboDocumentType);
