...
public static final String BASE_PANEL_NAME = "ComponentVersion Information";
...
detailSection.addScreenLine(CDetailLinesService.createSection(CComponentVersionInitializerService.BASE_PANEL_NAME));
