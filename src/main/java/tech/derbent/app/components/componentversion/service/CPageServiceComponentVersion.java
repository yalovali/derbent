...
public class CPageServiceComponentVersion extends CPageServiceDynamicPage<CComponentVersion> implements IPageServiceHasStatusAndWorkflow<CComponentVersion> {
...
public CPageServiceComponentVersion(IPageServiceImplementer<CComponentVersion> view) {
super(view);
...
this.getClass().getSimpleName(), CComponentVersion.class.getSimpleName());
Check.notNull(getView(), "View must not be null to bind page service.");
super.bind();
} catch (Exception e) {
LOGGER.error("Error binding {} to dynamic page for entity {}: {}", 
this.getClass().getSimpleName(), CComponentVersion.class.getSimpleName(), e.getMessage());
throw e;
}
}
