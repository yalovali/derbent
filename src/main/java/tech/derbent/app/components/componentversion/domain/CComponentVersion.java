...
@AMetaData (
displayName = "Component", required = true, readOnly = false, 
description = "Parent component", hidden = false, order = 1,
...
@AMetaData (
displayName = "Version Type", required = false, readOnly = false, 
description = "Type category of the version", hidden = false, order = 2,
...
@AMetaData (
displayName = "Version Number", required = false, readOnly = false, 
description = "Version identifier (e.g., 1.0.0)", hidden = false, order = 3
)
