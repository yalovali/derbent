...
@Menu (order = 0, icon = "vaadin:file-o", title = "Settings.Components")
@PermitAll
...
CComponentService(final IComponentRepository repository, final Clock clock, 
final ISessionService sessionService,
final CComponentTypeService componentTypeService,
...
componentTypeService, projectItemStatusService);
