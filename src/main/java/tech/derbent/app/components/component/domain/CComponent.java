...
@AMetaData (
displayName = "Component Type", required = false, readOnly = false, 
description = "Type category of the component", hidden = false, order = 2,
...
@AMetaData (
displayName = "Component Code", required = false, readOnly = false, 
description = "Unique component code or identifier", hidden = false, order = 3
)
