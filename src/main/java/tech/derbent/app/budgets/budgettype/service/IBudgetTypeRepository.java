...
public interface IBudgetTypeRepository extends IEntityOfProjectRepository<CBudgetType> {
	...
	@Query ("""
			...
			ORDER BY t.name ASC
			""")
	List<CBudgetType> listByProjectForPageView(@Param ("project") CProject project);
}
