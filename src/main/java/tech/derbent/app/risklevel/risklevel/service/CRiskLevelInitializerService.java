...
public class CRiskLevelInitializerService extends CInitializerServiceBase {
	...
	public static CDetailSection createBasicView(final CProject project) throws Exception {
		try {
			...
			detailSection.addScreenLine(CDetailLinesService.createSection(CRiskLevelInitializerService.BASE_PANEL_NAME));
			...
			LOGGER.error("Error creating risk level view.");
			throw e;
		}
	}
	...
	public static CGridEntity createGridEntity(final CProject project) {
		...
		grid.setColumnFields(List.of("id", "name", "description", "riskLevel", "status", "project", "assignedTo", "createdBy", "createdDate"));
		return grid;
	}
