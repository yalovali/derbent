...
import tech.derbent.app.invoices.invoice.service.CFinancialSummaryService;
 ...
 * Provides period-based filtering and real-time financial reporting. */
...
public class CFinancialDashboardView extends CAbstractPage {
	...
	public CFinancialDashboardView(
			final CFinancialSummaryService financialSummaryService,
	...
	private void refreshDashboard() {
		try {
			...
			final HorizontalLayout statusCardsLayout = (HorizontalLayout) getChildren()
				.filter(component -> "invoice-status-cards".equals(component.getId().orElse("")))
