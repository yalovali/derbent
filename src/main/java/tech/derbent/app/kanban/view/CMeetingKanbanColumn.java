...
import tech.derbent.app.meetings.view.CMeetingCard;

/** CMeetingKanbanColumn - Kanban column for meetings using the base kanban classes. Layer: View (MVC) This implementation uses the generic kanban
 * base classes to provide drag-and-drop functionality for meeting cards. */
