...
public class CAssetInitializerService extends CInitializerServiceBase {
	...
	public static CDetailSection createBasicView(final CProject project) throws Exception {
		try {
			...
			detailSection.addScreenLine(CDetailLinesService.createSection(CAssetInitializerService.BASE_PANEL_NAME));
	...
	public static void initializeSample(final CProject project, final boolean minimal) throws Exception {
		final String[][] nameAndDescriptions = {
				{
						"Development Laptop - MacBook Pro", "High-performance laptop for software development"
				}, {
						"Production Server - AWS EC2", "Cloud server instance for production environment"
				}
		};
