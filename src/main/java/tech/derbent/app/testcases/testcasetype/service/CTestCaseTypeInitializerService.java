...
public class CTestCaseTypeInitializerService extends CInitializerServiceBase {

	private static final Class<?> clazz = CTestCaseType.class;
	private static final Logger LOGGER = LoggerFactory.getLogger(CTestCaseTypeInitializerService.class);
	private static final String menuOrder = Menu_Order_TYPES + ".30";
	private static final String menuTitle = MenuTitle_TYPES + ".Test Case Types";
	private static final String pageDescription = "Manage test case type categories";
	private static final String pageTitle = "Test Case Types";
	...
	public static CDetailSection createBasicView(final CProject project) throws Exception {
		try {
			...
			LOGGER.error("Error creating test case type view.");
			throw e;
		}
	}
