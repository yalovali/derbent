...
public class CComponentListTestCases extends CVerticalLayout
	...
	@Override
	public String getComponentName() { return "testCases"; }
	...
	@Override
	public CAbstractService<?> getEntityService() { return testCaseService; }

	@Override
	public CGrid<CTestCase> getGrid() { return grid; }
