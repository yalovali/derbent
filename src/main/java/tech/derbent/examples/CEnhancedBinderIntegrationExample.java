...
/**
 * Example showing how to integrate enhanced binder with existing views with minimal changes. This demonstrates the
 * migration path from standard to enhanced binders.
 */
public class CEnhancedBinderIntegrationExample {
    ...
    public static class ConfigurableMeetingStatusView {
        ...
        public ConfigurableMeetingStatusView(final CAbstractService<CMeetingStatus> service,
    ...
    public static class ExplicitEnhancedMeetingStatusView {
        ...
        public ExplicitEnhancedMeetingStatusView(final CAbstractService<CMeetingStatus> service,
                final CSessionService sessionService) {
            this.service = service;
        ...
        public void validateAndShowErrors() {
            ...
            if (!isValid) {
                ...
                enhancedBinder.getFieldsWithErrors()
                        .forEach(field -> LOGGER.warn("  - {}: {}", field, enhancedBinder.getFieldError(field)));
            }
        }
    }
