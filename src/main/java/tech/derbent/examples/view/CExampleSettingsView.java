...
public class CExampleSettingsView extends Div implements IIconSet {
    ...
    public CExampleSettingsView() {
        ...
        for (int i = 1; i <= 6; i++) {
            final Card card = createCard("Component " + i, "This is the description for component " + i,
    ...
    private Card createCard(final String title, final String content, final VaadinIcon iconType) {
        ...
        header.getStyle().set("display", "flex").set("align-items", "center").set("gap", "8px").set("margin-bottom",
                "8px");
