...
/** Example view to demonstrate 4-level hierarchical menu structure. This view shows how the hierarchical menu parses deep menu annotations. */
...
public class CExampleHierarchicalMenuView extends Div implements IDisplayView {
	...
	public CExampleHierarchicalMenuView() {
		...
		final Paragraph implementation = new Paragraph("The hierarchical menu supports navigation up to 4 levels deep with "
		...
		final Paragraph features = new Paragraph(
				"Key features include: " + "• 4-level menu hierarchy support " + "• Sliding animations between levels " + "• Back button navigation "
						+ "• Visual depth indicators " + "• Responsive design " + "• Integration with existing menu system");
