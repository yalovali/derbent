...
/**
 * CSearchDemoView - Demonstration view showing search functionality. Layer: View (MVC)
 * 
 * A standalone demo page that shows the search toolbar and grid functionality without requiring database setup.
 */
@Route("search-demo")
@PermitAll
