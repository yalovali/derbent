...
/**
 * CSearchDemoView - Demonstration view showing search functionality.
 * Layer: View (MVC)
 * 
 * A standalone demo page that shows the search toolbar and grid functionality
    ...
    private void createProjectSection() {
        ...
        projectSearch.addSearchListener(event -> {
            ...
            if (searchText == null || searchText.trim().isEmpty()) {
                ...
                List<CProject> filtered = allProjects.stream()
                    .filter(project -> project.matches(searchText))
                    .toList();
    ...
    private void createUserSection() {
        ...
        userSearch.addSearchListener(event -> {
            ...
            if (searchText == null || searchText.trim().isEmpty()) {
                ...
                List<CUser> filtered = allUsers.stream()
                    .filter(user -> user.matches(searchText))
                    .toList();
