...
public class CScreenLinesService extends CAbstractService<CScreenLines> {
    ...
    @Override
    protected Class<CScreenLines> getEntityClass() {
        return CScreenLines.class;
    }
    ...
    public void moveLineDown(final CScreenLines screenLine) {
        final List<CScreenLines> lines = findByScreenOrderByLineOrder(screenLine.getScreen());
     ...
     */
    public CScreenLines newEntity(final CScreen screen, final String fieldCaption, final String entityProperty) {
        final CScreenLines screenLine = new CScreenLines(screen, fieldCaption, entityProperty);
