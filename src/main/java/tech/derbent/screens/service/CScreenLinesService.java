...
public class CScreenLinesService extends CAbstractService<CScreenLines> {
     ...
     */
    public CScreenLines newEntity(final CScreen screen, final String fieldClass, final String entityProperty) {
        final CScreenLines screenLine = new CScreenLines(screen, fieldClass, entityProperty);
