...
public class CViewsService {
	...
	/**
	 * Get available entity line class types for a given base entity type. This includes
	 * the entity itself and related entities accessible through relationships.
	...
	public List<String> getAvailableEntityLineTypes(final String baseEntityType) {
		LOGGER.debug("Retrieving available entity line types for base type: {}",
			baseEntityType);
	...
	/**
	 * Get the actual entity class name for a given entity line type. Maps descriptive
	 * names like "Project of Activity" to actual class names like "CProject".
	...
	public String getEntityClassNameForLineType(final String entityLineType) {
		...
		// Direct entity types
		if (entityLineType.equals("CActivity") || entityLineType.equals("CMeeting")
			|| entityLineType.equals("CRisk") || entityLineType.equals("CProject")
			|| entityLineType.equals("CUser")) {
		...
		else if (entityLineType.contains("User of")
			|| entityLineType.contains("Assigned User")
