...
public class CViewsService {
	...
	/**
	 * Get available entity line class types for a given base entity type.
	 * This includes the entity itself and related entities accessible through relationships.
	 * 
	...
	/**
	 * Get the actual entity class name for a given entity line type.
	 * Maps descriptive names like "Project of Activity" to actual class names like "CProject".
	 * 
