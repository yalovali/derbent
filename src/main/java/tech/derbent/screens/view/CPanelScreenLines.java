...
public class CPanelScreenLines extends CPanelScreenBase {
    ...
    public CPanelScreenLines(final CScreen currentEntity, final CEnhancedBinder<CScreen> beanValidationBinder,
    ...
    private void openAddFieldDialog()
        ...
        final CScreenLines newLine = screenLinesService.newEntity(getCurrentEntity(), CEntityFieldService.THIS_CLASS,
                "name");
        final CScreenLinesEditDialog dialog = new CScreenLinesEditDialog(newLine, this::saveScreenLine, true,
                entityFieldService, currentEntity);
        dialog.open();
    }
    ...
    private void openEditFieldDialog(final CScreenLines screenLine)
        ...
        final CScreenLinesEditDialog dialog = new CScreenLinesEditDialog(screenLine, this::saveScreenLine, false,
                entityFieldService, currentEntity);
        dialog.open();
    }
