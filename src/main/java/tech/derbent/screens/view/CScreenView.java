...
public final class CScreenView extends CProjectAwareMDPage<CScreen> {
    ...
    /**
     * Creates the entity details section using accordion panels.
     * Follows the same pattern as CActivitiesView for consistency.
     */
    @Override
    protected void createDetailsLayout() {
        // Create panels for different aspects of screen configuration
        
        // Basic screen information panel
        ...
        addAccordionPanel(new CPanelScreenLines(getCurrentEntity(), getBinder(),
                (CScreenService) entityService, screenLinesService));
    ...
    @Override
    protected void setProjectForEntity(final CScreen entity, final CProject project) {
