...
public class CSessionService {
    ...
    public CSessionService(final AuthenticationContext authenticationContext, final CUserService userService,
    ...
    /**
     * Registers a component to receive notifications when the project list changes. Components should call this method
     * when they are attached to the UI.
     * 
     * @param listener
    ...
    /**
     * Event listener for project list changes. This method is called when projects are created, updated, or deleted to
     * notify all registered listeners.
     * 
     * @param event
     *            The project list change event
     */
    @EventListener
    ...
    /**
     * Notifies all registered project list change listeners about changes to the project list. This method safely
     * handles UI access for components that may be in different UIs.
     */
    ...
    /**
     * Unregisters a component from receiving project list change notifications. Components should call this method when
     * they are detached from the UI.
     * 
     * @param listener
     *            The component to unregister
     */
