 ...
 * <p>
 * This class encapsulates a user ID string value, providing type safety and
 * validation. It follows the domain primitive pattern, ensuring that all user
 * IDs in the application are validated consistently and can be used as
 * immutable value objects.
 * </p>
 * <p>
 * UserId objects are immutable, serializable, and implement proper equality
 * semantics. They should be used throughout the application wherever a user ID
 * is needed, rather than using raw strings.
 * </p>
 * <p>
