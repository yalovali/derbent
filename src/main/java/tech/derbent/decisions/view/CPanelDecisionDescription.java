 ...
 * Displays and allows editing of fundamental decision fields including name, description,
 * decision type, and project information. Following the established pattern from
 * CPanelActivityDescription.
 */
public class CPanelDecisionDescription extends CPanelDecisionBase {
	...
	public CPanelDecisionDescription(final CDecision currentEntity,
		...
		final CDecisionService entityService) throws NoSuchMethodException,
