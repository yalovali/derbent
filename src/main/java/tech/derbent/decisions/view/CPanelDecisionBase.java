...
/**
 * CPanelDecisionBase - Abstract base class for decision entity panels. Layer: View (MVC) Provides common functionality
 * for all decision-related panels following the established patterns from CPanelActivityBase.
 */
public abstract class CPanelDecisionBase extends CAccordionDBEntity<CDecision> {
    ...
    protected void createPanelContent() {
        getBaseLayout().add(CEntityFormBuilder.buildForm(CDecision.class, getBinder(), getEntityFields()));
    }
}