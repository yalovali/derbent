...
/** CPanelDecisionBase - Abstract base class for decision entity panels. Layer: View (MVC) Provides common functionality for all decision-related
 * panels following the established patterns from CPanelActivityBase. */
public abstract class CPanelDecisionBase extends CAccordionDBEntity<CDecision> {
	...
	public CPanelDecisionBase(final String title, final CDecision currentEntity, final CEnhancedBinder<CDecision> beanValidationBinder,
