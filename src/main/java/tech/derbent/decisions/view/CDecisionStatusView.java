...
@PermitAll
public class CDecisionStatusView extends CAbstractMDPage<CDecisionStatus> {
    ...
    @Override
    protected CDecisionStatus newEntity() {
        LOGGER.info("newEntity called - creating new CDecisionStatus with defaults");
        final CDecisionStatus newStatus = new CDecisionStatus();
