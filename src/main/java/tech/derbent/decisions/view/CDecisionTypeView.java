...
@Menu (
	order = 11.1, icon = "class:tech.derbent.decisions.view.CDecisionTypeView",
	title = "Types.Decision Types"
)
@PermitAll
public class CDecisionTypeView extends CProjectAwareMDPage<CDecisionType>
	...
	protected void createGridForEntity() {
		...
		grid.addBooleanColumn(CDecisionType::requiresApproval, "Requires Approval",
			"Required", "Optional");
