...
public class CDecisionTypeService extends CEntityOfProjectService<CDecisionType> {
    ...
    public List<CDecisionType> findAllByProjectOrdered(final CProject project) {
        LOGGER.info("findAllByProjectOrdered called for project: {}", project != null ? project.getName() : "null");
    ...
    /**
     * Gets a decision type by ID with eagerly loaded relationships. Overrides parent get() method to prevent
    ...
    @Override
    @Transactional(readOnly = true)
    public Optional<CDecisionType> getById(final Long id) {
        ...
        final Optional<CDecisionType> entity = decisionTypeRepository.findByIdWithRelationships(id);
