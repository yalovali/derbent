...
/**
 * CDecisionRepository - Repository interface for CDecision entities.
 * Layer: Data Access (MVC)
 * 
 * Provides data access methods for decision entities including project-based queries
 * and eagerly loaded relationships to prevent LazyInitializationException.
 */
public interface CDecisionRepository extends CAbstractNamedRepository<CDecision> {
     ...
     */
    List<CDecision> findByProject(CProject project);
     ...
     */
    Page<CDecision> findByProject(CProject project, Pageable pageable);
    ...
    /**
     * Finds a decision by ID with eagerly loaded decision type and status to
    ...
    /**
     * Finds a decision by ID with all main relationships eagerly loaded to
     * prevent LazyInitializationException.
     * @param id the decision ID
     * @return optional CDecision with loaded relationships
     */
    @Query("SELECT d FROM CDecision d " +
    ...
    /**
     * Finds all decisions by project with eagerly loaded relationships to
     * prevent LazyInitializationException.
     * @param project the project
