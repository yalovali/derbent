...
public class CDecisionApprovalService extends CAbstractNamedEntityService<CDecisionApproval> {
    ...
    public long countApprovedApprovals(final CDecision decision) {
        LOGGER.info("countApprovedApprovals called with decision: {}", decision != null ? decision.getName() : "null");
    ...
    public long countPendingApprovals(final CDecision decision) {
        LOGGER.info("countPendingApprovals called with decision: {}", decision != null ? decision.getName() : "null");
    ...
    public List<CDecisionApproval> findByApprover(final CUser approver) {
        LOGGER.info("findByApprover called with approver: {}", approver != null ? approver.getName() : "null");
    ...
    public List<CDecisionApproval> findByDecision(final CDecision decision) {
        LOGGER.info("findByDecision called with decision: {}", decision != null ? decision.getName() : "null");
    ...
    public boolean isApprovalOverdue(final CDecisionApproval approval) {
        LOGGER.info("isApprovalOverdue called with approval: {}", approval != null ? approval.getName() : "null");
    ...
    public CDecisionApproval resetApprovalToPending(final CDecisionApproval approval) {
        LOGGER.info("resetApprovalToPending called with approval: {}", approval != null ? approval.getName() : "null");
