...
/**
 * CDecisionApprovalService - Service class for CDecisionApproval entities. Layer: Service
 * (MVC) Provides business logic operations for decision approval management including
 * validation, creation, approval workflow operations, and user-based queries.
 */
@Service
@PreAuthorize ("isAuthenticated()")
public class CDecisionApprovalService
	extends CAbstractNamedEntityService<CDecisionApproval> {

	public CDecisionApprovalService(final CDecisionApprovalRepository repository,
		final Clock clock) {
	 ...
	 */
	@Transactional
	public CDecisionApproval approveApproval(final CDecisionApproval approval,
	...
	public long countApprovedApprovals(final CDecision decision) {
		...
		return ((CDecisionApprovalRepository) repository)
			.countByDecisionAndIsApprovedTrue(decision);
	}
	...
	public long countPendingApprovals(final CDecision decision) {
		...
		return ((CDecisionApprovalRepository) repository)
			.countByDecisionAndIsApprovedIsNull(decision);
	}
	...
	public List<CDecisionApproval> findByDecisionWithApprover(final CDecision decision) {
		...
		return ((CDecisionApprovalRepository) repository)
			.findByDecisionWithApprover(decision);
	}
	...
	public List<CDecisionApproval> findOverdueApprovalsByUser(final CUser approver) {
		...
		return ((CDecisionApprovalRepository) repository)
			.findOverdueApprovalsByApprover(approver);
	}
	...
	public List<CDecisionApproval> findPendingApprovalsByUser(final CUser approver) {
		...
		return ((CDecisionApprovalRepository) repository)
			.findByApproverAndIsApprovedIsNull(approver);
	}
	 ...
	 */
	@Transactional
	public CDecisionApproval rejectApproval(final CDecisionApproval approval,
		final String comments) {
	 ...
	 */
	@Transactional
	public CDecisionApproval updateDueDate(final CDecisionApproval approval,
	 ...
	 */
	@Transactional
	public CDecisionApproval updatePriority(final CDecisionApproval approval,
