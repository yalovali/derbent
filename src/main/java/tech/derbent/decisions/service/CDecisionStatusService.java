 ...
 * operations for decision status management including validation, creation, and workflow management. Since
 * CDecisionStatus extends CStatus which extends CTypeEntity which extends CEntityOfProject, this service must extend
...
public class CDecisionStatusService extends CEntityOfProjectService<CDecisionStatus> {
    ...
    /**
     * Finds all non-final decision statuses for a specific project ordered by sort order. This replaces the problematic
     * findAllActiveOrdered() method that didn't require project.
     * 
     * @param project
    ...
    /**
     * Finds all final decision statuses for a specific project. This replaces the problematic findAllFinal() method
     * that didn't require project.
     * 
     * @param project
     *            the project to find statuses for
    ...
    /**
     * Finds all decision statuses for a specific project ordered by sort order. This replaces the problematic
     * findAllOrdered() method that didn't require project.
     * 
     * @param project
     *            the project to find statuses for
    ...
    /**
     * Finds decision statuses that require approval for a specific project. This replaces the problematic
     * findRequiringApproval() method that didn't require project.
     * 
     * @param project
     *            the project to find statuses for
