...
/**
 * CDecisionStatus - Domain entity representing decision status types.
 * Layer: Domain (MVC)
 * 
 * Inherits from CStatus to provide status functionality for decisions.
 * This entity defines the possible statuses a decision can have 
 * (e.g., DRAFT, UNDER_REVIEW, APPROVED, REJECTED, IMPLEMENTED).
 */
@Entity
...
public class CDecisionStatus extends CStatus {
    ...
    @MetaData(
        ...
        defaultValue = "true",
        description = "Whether decisions with this status can be edited",
    ...
    public CDecisionStatus() {
        super();
        LOGGER.debug("CDecisionStatus() - Creating new decision status instance");
    }
    ...
    public CDecisionStatus(final String name) {
        super(name);
        LOGGER.debug("CDecisionStatus constructor called with name: {}", name);
    ...
    public CDecisionStatus(final String name, final String description) {
        ...
        LOGGER.debug("CDecisionStatus constructor called with name: {}, description: {}", 
                    name, description);
    }
     ...
     */
    public CDecisionStatus(final String name, final String description, final String color,
                          final boolean isFinal, final boolean allowsEditing, 
                          final boolean requiresApproval) {
        super(name, description);
        LOGGER.debug("CDecisionStatus constructor called with name: {}, description: {}, color: {}, isFinal: {}, allowsEditing: {}, requiresApproval: {}", 
    ...
    public boolean isPendingApproval() {
        return requiresApproval && !isFinal;
    }
