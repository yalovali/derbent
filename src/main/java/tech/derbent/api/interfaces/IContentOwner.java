...
public interface IContentOwner {
	...
	default tech.derbent.app.workflow.service.CWorkflowStatusRelationService getWorkflowStatusRelationService() { return null; }
	...
	/** Called after grid data has been refreshed. Default implementation does nothing.
	 * Override to implement grid refresh logic if applicable. */
