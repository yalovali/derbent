...
public class CPageEntityInitializerService extends CProjectItemInitializerService {
	...
	public static CDetailSection createBasicView(final CProject<?> project) throws Exception {
		try {
			...
			detailSection
					.addScreenLine(CDetailLinesService.createLineFromDefaults(clazz, "attributeShowInQuickToolbar"));
	...
	public static CGridEntity createGridEntity(final CProject<?> project) {
		...
		grid.setColumnFields(List.of("id", "name", "menuTitle", "pageTitle", "menuOrder", "requiresAuthentication",
				"attributeShowInQuickToolbar", "attributeReadonly", "attributeNonDeletable"));
		return grid;
	}
	...
	public static void initialize(final CProject<?> project, final CGridEntityService gridEntityService,
		...
		initBase(clazz, project, gridEntityService, detailSectionService, pageEntityService, detailSection, grid,
				menuTitle, pageTitle, pageDescription, showInQuickToolbar, Menu_Order_DEVELOPMENT + menuOrder, null);
	}
}
