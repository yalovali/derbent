...
/**
 * Abstract base class for entity relationships with ownership capabilities.
 * This class provides common fields and methods for managing relationships
...
public abstract class CAbstractEntityRelationship<RelationshipClass> extends CEntityDB<RelationshipClass> {
    ...
    public void setOwnershipLevel(String ownershipLevel) {
        this.ownershipLevel = ownershipLevel != null ? ownershipLevel : "MEMBER";
    }
