...
public class CComponentWidgetEntity<EntityClass extends CEntityDB<?>> extends CHorizontalLayout
    ...
    public static <E extends CEntityDB<?>> Component createWidget(final E entity) {
        ...
        if (pageServiceClass != null) {
            try {
                ...
                LOGGER.debug("Could not create widget via page service for {}: {}", entityClass.getSimpleName(),
                        e.getMessage());
            }
        }
    ...
    public static <E extends CEntityDB<?>> ValueProvider<E, String> dateValueProvider(
            final Function<E, LocalDate> dateExtractor) {
