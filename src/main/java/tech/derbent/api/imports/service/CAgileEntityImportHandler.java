 ...
 * <p>
 * WHY: Epic/Feature/User Story share the same agile payload (schedule + estimation + AC/notes/results + sprint fields) via {@link CAgileEntity}.
 * Centralising the mapping avoids drift between handlers and ensures imports stay consistent as the agile model evolves.
 * </p>
 */
