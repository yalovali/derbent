...
public class CDashboardProjectTypeInitializerService extends CEntityTypeInitializerService {

	private static final Class<?> clazz = CDashboardProjectType.class;
	private static final Logger LOGGER = LoggerFactory.getLogger(CDashboardProjectTypeInitializerService.class);
	private static final String menuOrder = Menu_Order_TYPES + ".05";
	private static final String menuTitle = MenuTitle_TYPES + "." + MenuTitle_TYPES_PROJECT + ".Dashboard Types";
	private static final String pageDescription = "Manage dashboard type categories";
	private static final String pageTitle = "Dashboard Type Management";
	...
	public static CDetailSection createBasicView(final CProject<?> project) throws Exception {
		try {
			...
			LOGGER.error("Error creating dashboard project type view.");
			throw e;
		}
	}
	...
	public static void initializeSample(final CProject<?> project, final boolean minimal) throws Exception {
		final String[][] nameAndDescriptions = {
				{"Default", "Default dashboard type"}
		};
