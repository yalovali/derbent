...
public final class CCSVExporter {
     ...
     */
    public static <T> StreamResource exportToCSV(final List<T> data, final List<CReportFieldDescriptor> fields, 
     ...
     */
    private static <T> ByteArrayInputStream generateCSVStream(final List<T> data, 
            final List<CReportFieldDescriptor> fields) throws IOException {
     ...
     * @throws IOException if writing fails
     */
    private static void writeHeader(final OutputStreamWriter writer, final List<CReportFieldDescriptor> fields) 
            throws IOException {
        boolean first = true;
     ...
     * @throws IOException if writing fails
     */
    private static <T> void writeDataRow(final OutputStreamWriter writer, final T entity, 
            final List<CReportFieldDescriptor> fields) throws IOException {
        boolean first = true;
    ...
    private static String escapeCsvValue(final String value) {
        ...
        final boolean needsQuoting = value.contains(CSV_DELIMITER) || 
