...
public final class MainLayout extends AppLayout implements AfterNavigationObserver {
    ...
    MainLayout(final AuthenticationContext authenticationContext, final ISessionService sessionService,
            final CLayoutService layoutService,
            final PasswordEncoder passwordEncoder, final CUserService userService,
            final CSystemSettingsService systemSettingsService,
    ...
    private void openUserProfileDialog() {
        ...
        try {
            ...
            final CDialogUserProfile profileDialog = new CDialogUserProfile(currentCUser, this::saveUserProfile,
                    passwordEncoder);
            profileDialog.open();
