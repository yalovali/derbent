...
public class CNotificationService {
	...
	public void showConfirmationDialog(final String message, final Runnable onConfirm) {
	...
	public void showConfirmationDialog(final String message, final String confirmText, final Runnable onConfirm) {
		Check.notBlank(message, "Confirmation message cannot be empty");
