...
public abstract class CDialogDBRelation<RelationshipClass extends CEntityDB<RelationshipClass>, MainEntityClass extends CEntityDB<MainEntityClass>,
		RelatedEntityClass extends CEntityDB<RelatedEntityClass>> extends CDialogDBEdit<RelationshipClass> {

	protected static final Logger LOGGER = LoggerFactory.getLogger(CDialogDBRelation.class);
	...
	public CDialogDBRelation(final IContentOwner parentContent, final RelationshipClass relationship, final MainEntityClass mainEntity,
