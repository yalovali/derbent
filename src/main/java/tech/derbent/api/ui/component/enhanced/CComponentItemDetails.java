 ...
 * <p>
 * This component displays the details of a CProjectItem entity in a CDynamicPageRouter. When a value is set via setValue(), the component
 ...
 * @since 1.0 */
public class CComponentItemDetails extends CVerticalLayout implements HasValue<HasValue.ValueChangeEvent<CEntityNamed<?>>, CEntityNamed<?>> {
	...
	@Override
	public CEntityNamed<?> getValue() { return currentValue; }

	/** Checks if the component is empty (no value set).
	 * @return true if no value is set, false otherwise */
	@Override
	public boolean isEmpty() { return currentValue == null; }
	...
	/** Sets the value of this component (the entity to display). This will update the display to show the entity's detail page and fire value change
	 * events.
