...
public abstract class CComponentListEntityBase<MasterEntity extends CEntityDB<?>, ChildEntity extends CEntityDB<?> & IOrderedEntity>
	...
	protected CButton create_buttonAdd() {
		...
		button.addThemeVariants(ButtonVariant.LUMO_PRIMARY);
		button.addClickListener(e -> on_addButton_clicked());
		return button;
	}
	...
	protected CButton create_buttonDelete() {
		...
		button.addClickListener(e -> on_addDeleteButton_clicked());
		button.setEnabled(false);
		return button;
	}

	private Button create_buttonMoveDown() {
		final CButton button = new CButton(VaadinIcon.ARROW_DOWN.create());
		button.addClickListener(e -> on_moveDownButton_clicked());
		button.setEnabled(false);
		return button;
	}

	private Button create_buttonMoveUp() {
		final CButton button = new CButton(VaadinIcon.ARROW_UP.create());
		button.addClickListener(e -> on_moveUpButton_clicked());
		button.setEnabled(false);
		return button;
	}
	...
	protected void createToolbar(final String titleText) {
		...
		// Create buttons
		btnAdd = create_buttonAdd();
		btnDelete = create_buttonDelete();
		moveUpButton = create_buttonMoveUp();
		moveDownButton = create_buttonMoveDown();
		buttonLayout.add(btnAdd, btnDelete, moveUpButton, moveDownButton);
	...
	public Button getAddFromListButton() { return addFromListButton; }
	...
	protected void handleDoubleClick(final ChildEntity item) {
		try {
	...
	protected void handleSelectionChange(final ChildEntity item) {
		try {
