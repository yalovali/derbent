...
public class CCrudToolbar extends HorizontalLayout {
	...
	/** Adds a custom component to the toolbar after all standard buttons. Convenience method for adding components at the end of the toolbar.
	...
	/** Configure visibility of toolbar buttons with default clone visibility. Maintains backward compatibility. */
	...
	/** Configure visibility of toolbar buttons with default clone and report visibility. Maintains backward compatibility. */
	public void configureButtonVisibility(final boolean showNew, final boolean showSave, final boolean showDelete, final boolean showRefresh,
			final boolean showClone) {
	 ...
	 * buttons. */
	public void configureButtonVisibility(final boolean showNew, final boolean showSave, final boolean showDelete, final boolean showRefresh,
			final boolean showClone, final boolean showReport) {
	...
	public CButton getCloneButton() { return cloneButton; }
	...
	public CButton getReportButton() { return reportButton; }
