...
/**
 * CComponentListSprintItems - Component for managing CSprintItems in a CSprint.
 * Provides full CRUD functionality for sprint items with ordering and type selection.
 * 
...
public class CComponentListSprintItems extends CComponentListEntityBase<CSprintItem, CSprint> {
	 ...
	 */
	public CComponentListSprintItems(final CSprintItemService sprintItemService, 
	...
	@Override
	protected CSprint getMasterEntity() {
