...
/**
 * IHasValuePersistence - Interface for components with automatic value
 * persistence.
 * <p>
 * This interface provides default methods for automatic value persistence
 * following the same pattern used by CComboBox and CTextField. Components
 * implementing this interface get automatic save/restore functionality with
 * minimal code.
 * </p>
 * <p>
 * <b>Benefits:</b>
...
public interface IHasValuePersistence<T> extends HasValue<HasValue.ValueChangeEvent<T>, T> {
     ...
     * <p>
     * After calling this method, the component will no longer automatically save or
     * restore its value.
     * </p>
     * 
     ...
     * <li>Restore its value from session storage when the component attaches to the
     * UI</li>
     * </ul>
     * </p>
     * <p>
     * <b>IMPORTANT:</b> Only user changes (isFromClient() == true) trigger
     * automatic saving to prevent loops during restoration.
     * </p>
     * 
     ...
     * <p>
     * Default implementation retrieves from Spring context. Component can override
     * if needed.
     * </p>
     * 
     ...
     * <p>
     * This method is called automatically when persistence is enabled and the
     * component attaches.
     * </p>
     */
     ...
     * <p>
     * This method is called automatically when persistence is enabled and the value
     * changes.
     * </p>
     */
