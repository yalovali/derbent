 ...
 * <p>
 * This component extends Vaadin's ComboBox with automatic value persistence capabilities,
 * following the project's C-prefix naming convention.
 * </p>
 * 
 * <p>
 * <b>Key Features:</b>
 * <ul>
 * <li><b>Automatic Persistence:</b> Call {@link #enablePersistence(String, Function)} to automatically
 * save and restore values across page refreshes</li>
 ...
 * comboBox.enablePersistence(
 *     "filter_entityType",
 *     className -&gt; comboBox.getListDataView().getItems()
...
public class CComboBox<T> extends ComboBox<T> {
	...
	public void enablePersistence(final String storageKey, final Function<String, T> converter) {
		...
		this.persistenceKey = storageKey;
		this.persistenceConverter = converter;
