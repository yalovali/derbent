...
public final class CGridUtils {
	...
	public static void addStandardIdColumn(tech.derbent.api.views.grids.CGrid<?> grid, String entityIdField) {
	 ...
	 * @param grid          the grid to configure
	 * @param entityIdField the field name for routing */
	public static void addStandardNamedEntityColumns(tech.derbent.api.views.grids.CGrid<?> grid, String entityIdField) {
