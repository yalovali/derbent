...
public abstract class CEntityNamedInitializerService
	...
	public static void createBasicView(final CDetailSection scr,
			final Class<?> clazz,
			@SuppressWarnings ("unused") final CProject<?> project,
	...
	public static CDetailSection createTypeEntityView(final CProject<?> project,
			final Class<?> clazz, final String configSectionTitle,
			final boolean includeAudit, final String... extraDisplayFields)
			throws Exception {
		Check.notNull(project, "project cannot be null");
		final CDetailSection scr = createBaseScreenEntity(project, clazz);
		createBasicView(scr, clazz, project, true);
		scr.addScreenLine(
				CDetailLinesService.createLineFromDefaults(clazz, "company"));
		scr.addScreenLine(
				CDetailLinesService.createLineFromDefaults(clazz, "workflow"));
		scr.addScreenLine(
				CDetailLinesService.createSection(configSectionTitle));
		scr.addScreenLine(
				CDetailLinesService.createLineFromDefaults(clazz, "color"));
		scr.addScreenLine(
				CDetailLinesService.createLineFromDefaults(clazz, "sortOrder"));
		for (final String field : extraDisplayFields) {
			scr.addScreenLine(
					CDetailLinesService.createLineFromDefaults(clazz, field));
		}
		scr.addScreenLine(CDetailLinesService.createLineFromDefaults(clazz,
