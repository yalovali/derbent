...
/** Service that scans for @MyMenu annotations and builds menu entries. Similar to Vaadin's MenuConfiguration but for custom @MyMenu annotation.
 * Usage:
 *
 * <pre>
 * {@literal @}Autowired
...
public final class MyMenuConfiguration {
	...
	/** Scan classpath for @MyMenu annotated classes. Call this at application startup to build menu structure. This method is idempotent - multiple
	 * calls will only scan once. */
