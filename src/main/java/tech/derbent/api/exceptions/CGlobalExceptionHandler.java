...
/**
 * Global exception handler for Vaadin applications.
 * SET BREAKPOINT HERE on error() method to catch any exception.
 * 
 * This handler is registered with Vaadin and catches UI-related exceptions.
 */
@Component
public class CGlobalExceptionHandler implements ErrorHandler {
    ...
    /**
     * 🔴 SET BREAKPOINT HERE 🔴 - This catches ALL Vaadin UI exceptions
     * This method is called by Vaadin when any exception occurs in the UI
     */
    @Override
    public void error(ErrorEvent event) {
        // 🔴 SET BREAKPOINT ON THIS LINE 🔴
        LOGGER.error("🔥 VAADIN EXCEPTION CAUGHT: {} - {}", 
