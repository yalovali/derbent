...
public class CUserProjectRole extends CRole<CUserProjectRole> {
	...
	@CollectionTable (name = "cuserprojectrole_read_pages", joinColumns = @JoinColumn (name = "role_id"))
	...
	@ElementCollection (fetch = FetchType.EAGER)
	@CollectionTable (name = "cuserprojectrole_write_pages", joinColumns = @JoinColumn (name = "role_id"))
	@Column (name = "page_name", length = CEntityConstants.MAX_LENGTH_NAME)
	@AMetaData (
