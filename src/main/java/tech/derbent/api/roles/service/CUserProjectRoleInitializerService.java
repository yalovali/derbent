...
public class CUserProjectRoleInitializerService extends CInitializerServiceBase {
        ...
        public static CDetailSection createBasicView(final CProject project) {
                try {
                        ...
                        detailSection.addScreenLine(CDetailLinesService.createSection("Page Access Permissions"));
                        detailSection.addScreenLine(CDetailLinesService.createLineFromDefaults(ENTITY_CLASS, "readAccessPages"));
                        detailSection.addScreenLine(CDetailLinesService.createLineFromDefaults(ENTITY_CLASS, "writeAccessPages"));
                        ...
                        detailSection.addScreenLine(
                                        CDetailLinesService.createLineFromDefaults(ENTITY_CLASS, "attributeNonDeletable"));
                        ...
                        detailSection.addScreenLine(
                                        CDetailLinesService.createLineFromDefaults(ENTITY_CLASS, "lastModifiedDate"));
        ...
        public static CGridEntity createGridEntity(final CProject project, boolean attributeNone) {
                ...
                grid.setSelectedFields(
                                "id,name,description,project,isAdmin,isUser,isGuest,color,sortOrder,isActive,attributeNonDeletable");
                return grid;
        }
        ...
        public static void initialize(CProject project, CGridEntityService gridEntityService, CDetailSectionService detailSectionService,
                ...
                initBase(ENTITY_CLASS, project, gridEntityService, detailSectionService, pageEntityService, detailSection, grid,
                                "Setup.Project Roles", "Project Role Management",
                                "Manage project-specific roles and permissions", showInQuickToolbar);
        }
}
