...
public class CUserProjectRoleInitializerService extends CRoleInitializationService {
	...
	public static CDetailSection createBasicView(final CProject<?> project) throws Exception {
		try {
			...
			detailSection
					.addScreenLine(CDetailLinesService.createLineFromDefaults(ENTITY_CLASS, "attributeNonDeletable"));
			// Audit details
	...
	public static CGridEntity createGridEntity(final CProject<?> project, final boolean attributeNone) {
		...
		grid.setColumnFields(List.of("id", "name", "description", "company", "isAdmin", "isUser", "isGuest", "color",
				"sortOrder", "active", "attributeNonDeletable"));
		return grid;
	}
