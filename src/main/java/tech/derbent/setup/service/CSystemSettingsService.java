...
public class CSystemSettingsService extends CAbstractService<CSystemSettings> {
    ...
    public String[] getAllowedFileExtensions() {
        ...
        try {
            final Optional<String> result = Optional
                    .ofNullable(((CSystemSettings) repository).getAllowedFileExtensions());
    ...
    public double getMaxFileUploadSizeMb() {
        ...
        try {
            final Optional<java.math.BigDecimal> result = Optional
                    .ofNullable(((CSystemSettings) repository).getMaxFileUploadSizeMb());
    ...
    public CSystemSettings getOrCreateSystemSettings() {
        final Optional<CSystemSettings> existingSettings = ((CSystemSettingsRepository) repository)
                .findSystemSettings();
    ...
    public int getSessionTimeoutMinutes() {
        ...
        try {
            final Optional<Integer> result = Optional
                    .ofNullable(((CSystemSettings) repository).getSessionTimeoutMinutes());
    ...
    public boolean isMaintenanceModeEnabled() {
        ...
        try {
            final Optional<Boolean> result = Optional
                    .ofNullable(((CSystemSettings) repository).isMaintenanceModeEnabled());
    ...
    public boolean isStrongPasswordsRequired() {
        ...
        try {
            final Optional<Boolean> result = Optional
                    .of(((CSystemSettingsService) repository).isStrongPasswordsRequired());
