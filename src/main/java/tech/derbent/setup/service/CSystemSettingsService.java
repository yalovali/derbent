...
public class CSystemSettingsService extends CAbstractService<CSystemSettings> {
	...
	public Optional<String> getMaintenanceMessage() {
		...
		try {
			final Optional<String> result = Optional
				.ofNullable(((CSystemSettings) repository).getMaintenanceMessage());
			return result;
		} catch (final Exception e) {
	...
	public CSystemSettings getOrCreateSystemSettings() {
		final Optional<CSystemSettings> existingSettings =
			((CSystemSettingsRepository) repository).findSystemSettings();
	...
	public boolean isSystemInitialized() {
		...
		try {
			final boolean initialized =
				((CSystemSettingsRepository) repository).existsSystemSettings();
			return initialized;
		} catch (final Exception e) {
