...
/**
 * CSystemSettings - Domain entity representing system-wide configuration settings. Layer:
 * Domain (MVC) This entity stores application-level configurations that apply across the
 * entire system regardless of company, including application metadata, security settings,
...
public class CSystemSettings extends CEntityDB<CSystemSettings> {
	...
	@Column (
		name = "application_name", nullable = false,
		length = CEntityConstants.MAX_LENGTH_NAME
	)
	@Size (max = CEntityConstants.MAX_LENGTH_NAME)
	@MetaData (
		displayName = "Application Name", required = true, readOnly = false,
		defaultValue = "Derbent Project Management",
		description = "Name of the application", hidden = false, order = 1,
		maxLength = CEntityConstants.MAX_LENGTH_NAME
	)
	private String applicationName = "Derbent Project Management";

	@Column (
		name = "application_version", nullable = false,
		length = CEntityConstants.MAX_LENGTH_NAME
	)
	@Size (max = CEntityConstants.MAX_LENGTH_NAME)
	@MetaData (
		displayName = "Application Version", required = true, readOnly = false,
	...
	@Column (
		name = "application_description", nullable = true,
		length = CEntityConstants.MAX_LENGTH_DESCRIPTION
	)
	@Size (max = CEntityConstants.MAX_LENGTH_DESCRIPTION)
	@MetaData (
		displayName = "Application Description", required = false, readOnly = false,
		defaultValue = "Comprehensive project management solution",
		description = "Brief description of the application", hidden = false, order = 3,
	...
	@Column (
		name = "support_email", nullable = true, length = CEntityConstants.MAX_LENGTH_NAME
	)
	@Size (max = CEntityConstants.MAX_LENGTH_NAME)
	@MetaData (
		displayName = "Support Email", required = false, readOnly = false,
	...
	@MetaData (
		displayName = "Session Timeout (Minutes)", required = true, readOnly = false,
	...
	@MetaData (
		displayName = "Max Login Attempts", required = true, readOnly = false,
	...
	@MetaData (
		displayName = "Account Lockout Duration (Minutes)", required = true,
		readOnly = false, defaultValue = "15",
	...
	@MetaData (
		displayName = "Require Strong Passwords", required = true, readOnly = false,
	...
	@MetaData (
		displayName = "Password Expiry (Days)", required = false, readOnly = false,
		defaultValue = "90",
	...
	@MetaData (
		displayName = "Max File Upload Size (MB)", required = true, readOnly = false,
	...
	@Column (
		name = "allowed_file_extensions", nullable = true,
		length = CEntityConstants.MAX_LENGTH_DESCRIPTION
	)
	@Size (max = CEntityConstants.MAX_LENGTH_DESCRIPTION)
	@MetaData (
		...
		description = "Comma-separated list of allowed file extensions", hidden = false,
		order = 11, maxLength = CEntityConstants.MAX_LENGTH_DESCRIPTION
	)
	private String allowedFileExtensions =
		".pdf,.doc,.docx,.xls,.xlsx,.png,.jpg,.jpeg,.txt,.zip";

	@Column (
		name = "file_storage_path", nullable = true,
		length = CEntityConstants.MAX_LENGTH_DESCRIPTION
	)
	@Size (max = CEntityConstants.MAX_LENGTH_DESCRIPTION)
	@MetaData (
		displayName = "File Storage Path", required = false, readOnly = false,
		defaultValue = "./uploads", description = "Base path for file storage",
		hidden = false, order = 12, maxLength = CEntityConstants.MAX_LENGTH_DESCRIPTION
	)
	private String fileStoragePath = "./uploads";

	@Column (name = "enable_file_versioning", nullable = false)
	@MetaData (
		displayName = "Enable File Versioning", required = true, readOnly = false,
	...
	// Email Configuration
	@Column (
		name = "smtp_server", nullable = true, length = CEntityConstants.MAX_LENGTH_NAME
	)
	@Size (max = CEntityConstants.MAX_LENGTH_NAME)
	@MetaData (
		displayName = "SMTP Server", required = false, readOnly = false,
		defaultValue = "localhost", description = "SMTP server hostname", hidden = false,
		order = 14, maxLength = CEntityConstants.MAX_LENGTH_NAME
	)
	...
	@MetaData (
		displayName = "SMTP Port", required = true, readOnly = false,
		defaultValue = "587", description = "SMTP server port", hidden = false, order = 15
	)
	private Integer smtpPort = 587;

	@Column (name = "smtp_use_tls", nullable = false)
	@MetaData (
		displayName = "SMTP Use TLS", required = true, readOnly = false,
	...
	@Size (max = CEntityConstants.MAX_LENGTH_NAME)
	@MetaData (
		displayName = "System Email From", required = false, readOnly = false,
		defaultValue = "noreply@derbent.tech", description = "Default from email address",
		hidden = false, order = 17, maxLength = CEntityConstants.MAX_LENGTH_NAME
	)
	...
	@Size (
		max = CEntityConstants.MAX_LENGTH_NAME,
		message = "Database name cannot exceed " + CEntityConstants.MAX_LENGTH_NAME
			+ " characters"
	)
	...
	@MetaData (
		displayName = "Database Name", required = true, readOnly = false,
	...
	@MetaData (
		displayName = "Enable Database Logging", required = true, readOnly = false,
	...
	@MetaData (
		displayName = "Database Connection Pool Size", required = true, readOnly = false,
	...
	@MetaData (
		displayName = "Enable Caching", required = true, readOnly = false,
	...
	@MetaData (
		displayName = "Cache TTL (Minutes)", required = true, readOnly = false,
	...
	@MetaData (
		displayName = "Enable Automatic Backups", required = true, readOnly = false,
	...
	@Size (max = CEntityConstants.MAX_LENGTH_NAME)
	@MetaData (
		displayName = "Backup Schedule (Cron)", required = false, readOnly = false,
		defaultValue = "0 2 * * *", description = "Cron expression for backup schedule",
		hidden = false, order = 23, maxLength = CEntityConstants.MAX_LENGTH_NAME
	)
	...
	@MetaData (
		displayName = "Backup Retention (Days)", required = true, readOnly = false,
	...
	@MetaData (
		displayName = "Maintenance Mode", required = true, readOnly = false,
	...
	@MetaData (
		...
		description = "Message displayed during maintenance", hidden = false, order = 26,
		maxLength = CEntityConstants.MAX_LENGTH_DESCRIPTION
	)
	...
	@Column (
		name = "default_system_theme", nullable = false,
		length = CEntityConstants.MAX_LENGTH_NAME
	)
	@Size (max = CEntityConstants.MAX_LENGTH_NAME)
	@MetaData (
		displayName = "Default System Theme", required = true, readOnly = false,
		defaultValue = "lumo", description = "Default UI theme for the application",
		hidden = false, order = 27, maxLength = CEntityConstants.MAX_LENGTH_NAME
	)
	private String defaultSystemTheme = "lumo";

	@Column (name = "enable_dark_mode", nullable = false)
	@MetaData (
		displayName = "Enable Dark Mode", required = true, readOnly = false,
	...
	@MetaData (
		displayName = "Show System Info", required = true, readOnly = false,
		defaultValue = "true",
	...
	public String toString() {
		return "CSystemSettings{" + "applicationName='" + applicationName + '\''
			+ ", applicationVersion='" + applicationVersion + '\''
			+ ", sessionTimeoutMinutes=" + sessionTimeoutMinutes + ", maxLoginAttempts="
			+ maxLoginAttempts + ", maxFileUploadSizeMb=" + maxFileUploadSizeMb
			+ ", databaseName='" + databaseName + '\'' + ", enableDatabaseLogging="
			+ enableDatabaseLogging + ", maintenanceModeEnabled=" + maintenanceModeEnabled
			+ '}';
	}
}