...
public class CSystemSettings extends CEntityDB<CSystemSettings> {
    ...
    @AMetaData(displayName = "Application Name", required = true, readOnly = false, defaultValue = "Derbent Project Management", description = "Name of the application", hidden = false, order = 1, maxLength = CEntityConstants.MAX_LENGTH_NAME)
    ...
    @Size(max = CEntityConstants.MAX_LENGTH_NAME)
    @AMetaData(displayName = "Application Version", required = true, readOnly = false, defaultValue = "1.0.0", description = "Current version of the application", hidden = false, order = 2, maxLength = CEntityConstants.MAX_LENGTH_NAME)
    ...
    @AMetaData(displayName = "Application Description", required = false, readOnly = false, defaultValue = "Comprehensive project management solution", description = "Brief description of the application", hidden = false, order = 3, maxLength = CEntityConstants.MAX_LENGTH_DESCRIPTION)
    ...
    @Size(max = CEntityConstants.MAX_LENGTH_NAME)
    @AMetaData(displayName = "Support Email", required = false, readOnly = false, defaultValue = "support@derbent.tech", description = "Support contact email", hidden = false, order = 4, maxLength = CEntityConstants.MAX_LENGTH_NAME)
    ...
    @AMetaData(displayName = "Session Timeout (Minutes)", required = true, readOnly = false, defaultValue = "60", description = "User session timeout in minutes", hidden = false, order = 5)
    ...
    @AMetaData(displayName = "Max Login Attempts", required = true, readOnly = false, defaultValue = "3", description = "Maximum failed login attempts before lockout", hidden = false, order = 6)
    ...
    @AMetaData(displayName = "Account Lockout Duration (Minutes)", required = true, readOnly = false, defaultValue = "15", description = "Account lockout duration after failed attempts", hidden = false, order = 7)
    private Integer accountLockoutDurationMinutes = 15;

    @Column(name = "require_strong_passwords", nullable = false)
    @AMetaData(displayName = "Require Strong Passwords", required = true, readOnly = false, defaultValue = "true", description = "Enforce strong password requirements", hidden = false, order = 8)
    ...
    @AMetaData(displayName = "Password Expiry (Days)", required = false, readOnly = false, defaultValue = "90", description = "Password expiration in days (null for no expiry)", hidden = false, order = 9)
    ...
    @AMetaData(displayName = "Max File Upload Size (MB)", required = true, readOnly = false, defaultValue = "50.0", description = "Maximum file upload size in megabytes", hidden = false, order = 10)
    ...
    @Size(max = CEntityConstants.MAX_LENGTH_DESCRIPTION)
    @AMetaData(displayName = "Allowed File Extensions", required = false, readOnly = false, defaultValue = ".pdf,.doc,.docx,.xls,.xlsx,.png,.jpg,.jpeg,.txt,.zip", description = "Comma-separated list of allowed file extensions", hidden = false, order = 11, maxLength = CEntityConstants.MAX_LENGTH_DESCRIPTION)
    ...
    @Size(max = CEntityConstants.MAX_LENGTH_DESCRIPTION)
    @AMetaData(displayName = "File Storage Path", required = false, readOnly = false, defaultValue = "./uploads", description = "Base path for file storage", hidden = false, order = 12, maxLength = CEntityConstants.MAX_LENGTH_DESCRIPTION)
    private String fileStoragePath = "./uploads";

    @Column(name = "enable_file_versioning", nullable = false)
    @AMetaData(displayName = "Enable File Versioning", required = true, readOnly = false, defaultValue = "true", description = "Enable file version tracking", hidden = false, order = 13)
    ...
    @Size(max = CEntityConstants.MAX_LENGTH_NAME)
    @AMetaData(displayName = "SMTP Server", required = false, readOnly = false, defaultValue = "localhost", description = "SMTP server hostname", hidden = false, order = 14, maxLength = CEntityConstants.MAX_LENGTH_NAME)
    private String smtpServer = "localhost";

    @Column(name = "smtp_port", nullable = false)
    @Min(value = 1, message = "SMTP port must be positive")
    @Max(value = 65535, message = "SMTP port must be valid")
    @AMetaData(displayName = "SMTP Port", required = true, readOnly = false, defaultValue = "587", description = "SMTP server port", hidden = false, order = 15)
    private Integer smtpPort = 587;

    @Column(name = "smtp_use_tls", nullable = false)
    @AMetaData(displayName = "SMTP Use TLS", required = true, readOnly = false, defaultValue = "true", description = "Use TLS for SMTP connection", hidden = false, order = 16)
    ...
    @Size(max = CEntityConstants.MAX_LENGTH_NAME)
    @AMetaData(displayName = "System Email From", required = false, readOnly = false, defaultValue = "noreply@derbent.tech", description = "Default from email address", hidden = false, order = 17, maxLength = CEntityConstants.MAX_LENGTH_NAME)
    ...
    @AMetaData(displayName = "Database Name", required = true, readOnly = false, defaultValue = "derbent", description = "Name of the database to connect to", hidden = false, order = 17, maxLength = CEntityConstants.MAX_LENGTH_NAME)
    private String databaseName = "derbent";

    @Column(name = "enable_database_logging", nullable = false)
    @AMetaData(displayName = "Enable Database Logging", required = true, readOnly = false, defaultValue = "false", description = "Enable detailed database query logging", hidden = false, order = 18)
    ...
    @AMetaData(displayName = "Database Connection Pool Size", required = true, readOnly = false, defaultValue = "10", description = "Maximum database connections in pool", hidden = false, order = 19)
    private Integer databaseConnectionPoolSize = 10;

    @Column(name = "enable_caching", nullable = false)
    @AMetaData(displayName = "Enable Caching", required = true, readOnly = false, defaultValue = "true", description = "Enable application-level caching", hidden = false, order = 20)
    ...
    @AMetaData(displayName = "Cache TTL (Minutes)", required = true, readOnly = false, defaultValue = "30", description = "Cache time-to-live in minutes", hidden = false, order = 21)
    private Integer cacheTtlMinutes = 30;

    // Backup and Maintenance Settings
    @Column(name = "enable_automatic_backups", nullable = false)
    @AMetaData(displayName = "Enable Automatic Backups", required = true, readOnly = false, defaultValue = "true", description = "Enable scheduled database backups", hidden = false, order = 22)
    ...
    @Size(max = CEntityConstants.MAX_LENGTH_NAME)
    @AMetaData(displayName = "Backup Schedule (Cron)", required = false, readOnly = false, defaultValue = "0 2 * * *", description = "Cron expression for backup schedule", hidden = false, order = 23, maxLength = CEntityConstants.MAX_LENGTH_NAME)
    ...
    @AMetaData(displayName = "Backup Retention (Days)", required = true, readOnly = false, defaultValue = "30", description = "Number of days to retain backups", hidden = false, order = 24)
    private Integer backupRetentionDays = 30;

    @Column(name = "maintenance_mode_enabled", nullable = false)
    @AMetaData(displayName = "Maintenance Mode", required = true, readOnly = false, defaultValue = "false", description = "Enable maintenance mode", hidden = false, order = 25)
    ...
    @Size(max = CEntityConstants.MAX_LENGTH_DESCRIPTION)
    @AMetaData(displayName = "Maintenance Message", required = false, readOnly = false, defaultValue = "System is under maintenance. Please try again later.", description = "Message displayed during maintenance", hidden = false, order = 26, maxLength = CEntityConstants.MAX_LENGTH_DESCRIPTION)
    ...
    @Size(max = CEntityConstants.MAX_LENGTH_NAME)
    @AMetaData(displayName = "Default System Theme", required = true, readOnly = false, defaultValue = "lumo", description = "Default UI theme for the application", hidden = false, order = 27, maxLength = CEntityConstants.MAX_LENGTH_NAME)
    private String defaultSystemTheme = "lumo";

    @Column(name = "enable_dark_mode", nullable = false)
    @AMetaData(displayName = "Enable Dark Mode", required = true, readOnly = false, defaultValue = "true", description = "Allow users to switch to dark mode", hidden = false, order = 28)
    private Boolean enableDarkMode = Boolean.TRUE;

    @Column(name = "show_system_info", nullable = false)
    @AMetaData(displayName = "Show System Info", required = true, readOnly = false, defaultValue = "true", description = "Display system information to administrators", hidden = false, order = 29)
