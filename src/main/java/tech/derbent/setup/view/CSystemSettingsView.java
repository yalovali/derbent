...
public class CSystemSettingsView extends CAbstractPage {
	...
	private final com.vaadin.flow.data.binder.BeanValidationBinder<
		CSystemSettings> binder;
	...
	public CSystemSettingsView(final CSystemSettingsService systemSettingsService) {
		...
		this.binder =
			new com.vaadin.flow.data.binder.BeanValidationBinder<>(CSystemSettings.class);
		LOGGER.info(
