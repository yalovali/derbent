...
public class CMeetingService extends CEntityOfProjectService<CMeeting>
    ...
    /**
     * Overrides the standard getById method to use repository method with all relationships loaded for CMeeting
     * specific needs.
     * 
     * @param id
     *            the meeting ID
    ...
    /**
     * Simplified lazy field initialization for CMeeting entity. With eager loading of small entities (meetingType,
     * status, responsible), this mainly handles complex collections like participants and attendees.
     * 
     * @param entity
