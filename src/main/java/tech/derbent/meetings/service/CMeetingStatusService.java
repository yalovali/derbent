...
public class CMeetingStatusService extends CEntityOfProjectService<CMeetingStatus> {
	...
	public List<CMeetingStatus> findAllActiveStatusesByProject(final CProject project) {
		LOGGER.debug(
			"findAllActiveStatusesByProject() - Finding all active meeting statuses for project: {}",
	...
	/**
	 * Find all meeting statuses for a specific project ordered by sort order. This
	...
	public List<CMeetingStatus> findAllFinalStatusesByProject(final CProject project) {
		LOGGER.debug(
			"findAllFinalStatusesByProject() - Finding all final meeting statuses for project: {}",
			project != null ? project.getName() : "null");
