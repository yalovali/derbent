 ...
 * Inherits from CStatus to provide status functionality for meetings. This entity
 * defines the possible statuses a meeting can have (e.g., PLANNED, IN_PROGRESS, COMPLETED, CANCELLED).
 */
@Entity
...
public class CMeetingStatus extends CStatus {
	...
	public CMeetingStatus(final String name) {
		super(name);
	}

	public CMeetingStatus(final String name, final String description) {
