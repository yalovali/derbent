...
/**
 * CMeeting - Domain entity representing meetings. Layer: Domain (MVC) Inherits from
 * CEntityOfProject to provide project association.
 */
@Entity
...
public class CMeeting extends CEntityOfProject<CMeeting> implements CKanbanEntity {
	...
	@MetaData (
		...
		description = "Type category of the meeting", hidden = false, order = 2,
	...
	@MetaData (
		...
		description = "Start date and time of the meeting", hidden = false, order = 4
	)
	...
	@MetaData (
		...
		description = "End date and time of the meeting", hidden = false, order = 5
	)
	...
	@MetaData (
		...
		description = "Meeting agenda and topics to be discussed", hidden = false,
		order = 7, maxLength = 4000
	)
	...
	@MetaData (
		...
		order = 8, dataProviderBean = "CActivityService"
	)
	...
	@MetaData (
		...
		description = "Current status of the meeting", hidden = false, order = 9,
	...
	@MetaData (
		...
		description = "Person responsible for organizing and leading the meeting",
		hidden = false, order = 10, dataProviderBean = "CUserService"
	)
	...
	@Size (max = 4000)
	@MetaData (
		displayName = "Meeting Minutes", required = false, readOnly = false,
		defaultValue = "", description = "Notes and minutes from the meeting",
		hidden = false, order = 11, maxLength = 4000
	)
	...
	@MetaData (
		...
		description = "Users who actually attended the meeting", hidden = false,
	...
	@MetaData (
		...
		order = 13, dataProviderBean = "CUserService"
	)
	...
	public Set<CUser> getAttendees() {
		return attendees == null ? new HashSet<>() : new HashSet<>(attendees);
	}
	...
	public Set<CUser> getParticipants() {
		return participants == null ? new HashSet<>() : new HashSet<>(participants);
	}
