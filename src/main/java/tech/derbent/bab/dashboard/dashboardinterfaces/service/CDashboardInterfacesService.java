 ...
 * <p>
 * Following Derbent pattern: Concrete service with @Service annotation and interfaces. Manages CDashboardInterfaces entities with BAB-specific
...
public class CDashboardInterfacesService extends CProjectItemService<CDashboardInterfaces> implements IEntityRegistrable, IEntityWithView {
	...
	public List<CDashboardInterfaces> findActiveByProject(final Long projectId) {
		...
		return ((IDashboardInterfacesRepository) repository).findByProjectIdAndActive(projectId, true);
	}
	...
	@Override
	public Class<CDashboardInterfaces> getEntityClass() { return CDashboardInterfaces.class; }
	...
	protected void validateEntity(final CDashboardInterfaces entity) {
		...
		Check.notNull(entity.getActive(), "Active status is required");
