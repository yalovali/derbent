 ...
 * <p>
 * Displays CAN bus interfaces for BAB Gateway projects with configuration options.
 * Shows CAN interface information including:
 * <ul>
...
public class CComponentCanInterfaces extends CComponentBabBase {
    ...
    protected void initializeComponents() {
        ...
        // STEP 3: Create toolbar with actions
        createToolbar();

        // STEP 4: Create and configure grid
        createGrid();
    ...
    private void createToolbar() {
        final CH4 title = new CH4("CAN Interfaces");
        ...
        buttonEdit.setEnabled(false); // Enabled when row selected
        buttonEdit.addClickListener(e -> on_buttonEdit_clicked());

        final CHorizontalLayout toolbar = new CHorizontalLayout(title, buttonRefresh, buttonAdd, buttonEdit);
        toolbar.setWidthFull();
        toolbar.setAlignItems(CHorizontalLayout.Alignment.CENTER);
    ...
    private void configureGridColumns() {
        // Name column
        grid.addColumn(CBabNodeCAN::getName)
        ...
        // Node Type column
        grid.addColumn(CBabNodeCAN::getNodeType)
            .setHeader("Type")
            .setWidth("100px")
            .setFlexGrow(0)
            .setSortable(true)
        ...
        // Port Number column
        grid.addColumn(node -> node.getPortNumber() != null ? node.getPortNumber().toString() : "")
            .setHeader("Port")
            .setWidth("80px")
            .setFlexGrow(0)
            .setSortable(true)
        ...
        // Description column
        grid.addColumn(CBabNodeCAN::getDescription)
