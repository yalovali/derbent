 ...
 * <p>
 * Displays Ethernet/Network interfaces for BAB Gateway projects with configuration options. Shows network interface information including IP
 * configuration, DHCP settings, and network status. */
public class CComponentEthernetInterfaces extends CComponentBabBase {
	...
	@Override
	protected String getHeaderText() { return "Ethernet Interfaces"; }
