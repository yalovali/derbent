...
public class CComponentDiskUsage extends CComponentBabBase {
	...
	private void configureGrid() {
		// Mount point column
		CGrid.styleColumnHeader(grid.addColumn(CDTODiskInfo::getMountPoint).setWidth("150px").setFlexGrow(0).setKey("mountPoint").setSortable(true)
				.setResizable(true), "Mount Point");
		// Filesystem column
		CGrid.styleColumnHeader(grid.addColumn(CDTODiskInfo::getFilesystem).setWidth("180px").setFlexGrow(0).setKey("filesystem").setSortable(true)
				.setResizable(true), "Filesystem");
		// Type column
