 ...
 * <p>
 * Displays disk usage for BAB Gateway projects with real-time data from Calimero HTTP API.
 * Shows filesystem information including:
 * <ul>
...
public class CComponentDiskUsage extends CComponentBabBase {
	...
	private void configureGrid() {
		...
		CGrid.styleColumnHeader(
				grid.addColumn(CDiskInfo::getMountPoint)
						.setWidth("150px")
						.setFlexGrow(0)
						.setKey("mountPoint")
						.setSortable(true)
		...
		// Filesystem column
		CGrid.styleColumnHeader(
				grid.addColumn(CDiskInfo::getFilesystem)
						.setWidth("180px")
						.setFlexGrow(0)
						.setKey("filesystem")
						.setSortable(true)
		...
		// Type column
		CGrid.styleColumnHeader(
				grid.addColumn(CDiskInfo::getType)
						.setWidth("80px")
						.setFlexGrow(0)
						.setKey("type")
						.setSortable(true)
		...
		CGrid.styleColumnHeader(
				grid.addColumn(CDiskInfo::getUsageDisplay)
						.setWidth("220px")
						.setFlexGrow(0)
						.setKey("usage")
						.setSortable(true)
		...
		CGrid.styleColumnHeader(grid.addComponentColumn(disk -> {
			...
			return availSpan;
		}).setWidth("120px").setFlexGrow(0).setKey("available").setSortable(true).setResizable(true),
		"Available");
		...
		CGrid.styleColumnHeader(grid.addComponentColumn(disk -> {
			...
			return layout;
		}).setWidth("180px").setFlexGrow(0).setKey("progress").setSortable(true).setResizable(true),
		"Usage %");
		
		// Inodes column
		CGrid.styleColumnHeader(
				grid.addColumn(CDiskInfo::getInodesDisplay)
						.setWidth("220px")
						.setFlexGrow(1)
						.setKey("inodes")
						.setSortable(true)
