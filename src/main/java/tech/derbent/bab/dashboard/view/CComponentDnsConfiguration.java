...
public class CComponentDnsConfiguration extends CComponentBabBase {
	...
	private void openDnsEditDialog() {
		try {
			final tech.derbent.bab.dashboard.view.dialog.CDialogEditDnsConfiguration dialog =
					new tech.derbent.bab.dashboard.view.dialog.CDialogEditDnsConfiguration(currentDnsServers,
