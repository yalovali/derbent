...
/** CBabHttpServerNodeService - Service for HTTP Server virtual network nodes. Layer: Service (MVC) Active when: 'bab' profile is active Following
...
public class CBabHttpServerNodeService extends CBabNodeService<CBabHttpServerNode> implements IEntityRegistrable, IEntityWithView {
	...
	public CBabHttpServerNodeService(final IHttpServerNodeRepository repository, final Clock clock, final ISessionService sessionService) {
	...
	@Override
	public Class<?> getInitializerServiceClass() { return CBabHttpServerNodeInitializerService.class; }

	@Override
	public Class<?> getPageServiceClass() { return CPageServiceHttpServerNode.class; }
	// IEntityRegistrable implementation

	@Override
	public Class<?> getServiceClass() { return CBabHttpServerNodeService.class; }
