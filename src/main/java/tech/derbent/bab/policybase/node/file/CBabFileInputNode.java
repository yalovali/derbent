...
public class CBabFileInputNode extends CBabNodeEntity<CBabFileInputNode> {
	...
	@AMetaData (
			...
			dataProviderMethod = "getComboValuesOfPollingIntervalSeconds"
	)
	...
	public void setAutoDeleteProcessed(final Boolean autoDeleteProcessed) {
	...
	public void setBackupProcessedFiles(final Boolean backupProcessedFiles) {
	...
	public void setPollingIntervalSeconds(final Integer pollingIntervalSeconds) {
		this.pollingIntervalSeconds = pollingIntervalSeconds;
		updateLastModified();
	}

	public void setWatchDirectory(final Boolean watchDirectory) {
