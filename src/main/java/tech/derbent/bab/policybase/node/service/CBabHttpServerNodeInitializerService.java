...
/** CBabHttpServerNodeInitializerService - Initializer for HTTP Server nodes. Layer: Service (MVC) Active when: 'bab' profile is active Following
 * Derbent pattern: Entity initializer with UI definition. Creates dynamic pages and grids for HTTP Server node management. Defines form layout with
 * node configuration and HTTP-specific fields. */
@Service
@Profile ("bab")
public final class CBabHttpServerNodeInitializerService extends CInitializerServiceBase {
	...
	/** Initialize HTTP Server node pages for project. Creates menu entry, grid, and detail views. */
	public static void initialize(final CProject<?> project, final CGridEntityService gridEntityService,
			final CDetailSectionService detailSectionService, final CPageEntityService pageEntityService) throws Exception {
		final CDetailSection detailSection = createBasicView(project);
		final CGridEntity grid = createGridEntity(project);
		initBase(clazz, project, gridEntityService, detailSectionService, pageEntityService, detailSection, grid, "Policies.HTTP Servers", // Menu
																																			// title
																																			// (hierarchical)
	...
	public static void initializeSample(final CProject<?> project, final boolean minimal) throws Exception {
		...
		final CBabHttpServerNodeService service = (CBabHttpServerNodeService) CSpringContext.getBean(CEntityRegistry.getServiceClassForEntity(clazz));
