...
/**
 * CBabPolicybaseInitializerService - Sample data initializer for BAB policybase entities.
 * 
 * Creates sample triggers, actions, and filters for BAB policy rules system.
 * Provides complete examples of each entity type with realistic configurations.
 * 
 * Layer: Service (MVC)
 * Active when: 'bab' profile is active
 * Following Derbent pattern: Initializer service for sample data
 */
@Service
@Profile("bab")
public class CBabPolicybaseInitializerService extends CInitializerServiceBase {
    ...
    public CBabPolicybaseInitializerService(
            final CBabPolicyTriggerService triggerService,
            final CBabPolicyActionService actionService,
     ...
     */
    @Transactional
    public void initializeSamplePolicybaseEntities(final CProject<?> project, final CCompany company) {
        ...
        try {
            ...
            LOGGER.info("Successfully initialized {} policybase entities for project '{}'",
                    "sample", project.getName());

        } catch (final Exception e) {
            LOGGER.error("Failed to initialize policybase sample entities for project '{}': {}",
