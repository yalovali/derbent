...
/**
 * CSystemSettings_Bab - BAB IoT Gateway-specific system settings.
 * Layer: Domain (MVC)
 * Active when: 'bab' profile is active
 * 
 * Minimal configuration for IoT gateway functionality:
...
public class CSystemSettings_Bab extends CSystemSettings<CSystemSettings_Bab> {
    ...
    @AMetaData(
        ...
        required = false,
        readOnly = false,
        description = "Primary IP address of the IoT gateway",
        hidden = false,
        maxLength = 45
    )
    ...
    @AMetaData(
        ...
        readOnly = false,
        defaultValue = "8080",
        description = "Primary communication port for IoT gateway",
        hidden = false
    )
    ...
    @AMetaData(
        displayName = "Device Scan Interval (Seconds)",
        required = true,
        readOnly = false,
        defaultValue = "30",
        description = "How often to scan for connected IoT devices",
        hidden = false
    )
    ...
    @AMetaData(
        displayName = "Enable Device Auto-Discovery",
        required = true,
        readOnly = false,
        defaultValue = "true",
        description = "Automatically discover and register new IoT devices",
        hidden = false
    )
    ...
    public Integer getDeviceScanIntervalSeconds() {
        return deviceScanIntervalSeconds;
    }

    public void setDeviceScanIntervalSeconds(final Integer deviceScanIntervalSeconds) {
        this.deviceScanIntervalSeconds = deviceScanIntervalSeconds;
    ...
    public void setMaxConcurrentConnections(final Integer maxConcurrentConnections) {
        this.maxConcurrentConnections = maxConcurrentConnections;
        
    }

    public Boolean getEnableDeviceAutoDiscovery() {
        return enableDeviceAutoDiscovery;
    }

    public void setEnableDeviceAutoDiscovery(final Boolean enableDeviceAutoDiscovery) {
        this.enableDeviceAutoDiscovery = enableDeviceAutoDiscovery;
        
    }

    public Boolean isEnableDeviceAutoDiscovery() {
        return enableDeviceAutoDiscovery;
    }
    ...
    public String toString() {
        return "CSystemSettings_Bab{" +
                "applicationName='" + getApplicationName() + '\'' +
                ", gatewayIpAddress='" + gatewayIpAddress + '\'' +
                ", gatewayPort=" + gatewayPort +
                ", deviceScanIntervalSeconds=" + deviceScanIntervalSeconds +
                ", maxConcurrentConnections=" + maxConcurrentConnections +
                ", enableDeviceAutoDiscovery=" + enableDeviceAutoDiscovery +
                '}';
    }
}