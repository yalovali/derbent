...
public final class CPageServiceSystemSettings_Bab extends CPageServiceSystemSettings<CSystemSettings_Bab> {
	...
	public Component createComponentCComponentCalimeroStatus() {
		try {
			...
			final CComponentCalimeroStatus component = new CComponentCalimeroStatus(calimeroProcessManager, clientProjectService);
			...
			component.addValueChangeListener(event -> LOGGER.debug("Calimero settings changed via component: enabled={}, path={}",
