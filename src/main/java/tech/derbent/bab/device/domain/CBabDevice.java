...
/**
 * CBabDevice - IoT gateway device entity.
 * Following Derbent pattern: Entity extends CEntityOfCompany.
 * Represents single unique device instance per company.
 */
@Entity
...
public class CBabDevice extends CEntityOfCompany<CBabDevice> {
	...
	@Size(max = 100)
	@AMetaData(
		displayName = "Firmware Version", required = false, readOnly = false, 
		description = "Current firmware version", hidden = false, maxLength = 100
	)
	...
	@Size(max = 100)
	@AMetaData(
		displayName = "Hardware Revision", required = false, readOnly = false, 
		description = "Hardware revision", hidden = false, maxLength = 100
	)
	...
	@AMetaData(
		...
		description = "Current device status (Online, Offline, Error)", hidden = false, maxLength = 50
	)
	private String deviceStatus;

	@Column(name = "last_seen", nullable = true)
	@AMetaData(
		displayName = "Last Seen", required = false, readOnly = true, 
		description = "Last time device was online", hidden = false
	)
	...
	@AMetaData(
		...
		description = "Device IP address", hidden = false, maxLength = 45
	)
	...
	@Size(max = 17)
	@AMetaData(
		displayName = "MAC Address", required = false, readOnly = false, 
		description = "Device MAC address", hidden = false, maxLength = 17
	)
	...
	@AMetaData(
		...
		description = "User who created this device", hidden = false,
