...
public class CBabDeviceInitializerService extends CEntityOfCompanyInitializerService {
	...
	public static CGridEntity createGridEntity(final CProject<?> project) {
		...
		grid.setColumnFields(List.of("id", "name", "description", "serialNumber", "firmwareVersion", "hardwareRevision",
				"deviceStatus", "lastSeen", "ipAddress", "macAddress", "company", "createdBy", "active", "createdDate",
				"lastModifiedDate"));
		return grid;
	}
	...
	public static void initializeSample(final CProject<?> project, final boolean minimal) throws Exception {
		...
		final CBabDeviceService deviceService =
				(CBabDeviceService) CSpringContext.getBean(CEntityRegistry.getServiceClassForEntity(clazz));
