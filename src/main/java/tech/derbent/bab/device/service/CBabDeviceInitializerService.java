...
/** Initializer service for BAB device. Following Derbent pattern: createBasicView, createGridEntity, initialize, initializeSample. */
public class CBabDeviceInitializerService extends CInitializerServiceBase {
	...
	public static CGridEntity createGridEntity(final CProject project) {
		...
		grid.setColumnFields(List.of("id", "name", "description", "serialNumber", "firmwareVersion", "hardwareRevision", "deviceStatus", "lastSeen",
				"ipAddress", "macAddress", "company", "createdBy", "active", "createdDate", "lastModifiedDate"));
		return grid;
	}
	...
	/** Initialize sample BAB device with nodes. Following Derbent pattern: uses project parameter, gets company from project.
