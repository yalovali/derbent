...
/**
 * Service class for CBabNodeEthernet entity. 
 * Provides business logic for Ethernet communication node management.
...
public class CBabNodeEthernetService extends CBabNodeService<CBabNodeEthernet> implements IEntityRegistrable, IEntityWithView {
    ...
    @Override
    public Class<CBabNodeEthernet> getEntityClass() {
        return CBabNodeEthernet.class;
    }
    ...
    @Override
    public void initializeNewEntity(final CBabNodeEthernet entity) {
        super.initializeNewEntity(entity);
        LOGGER.debug("Initializing Ethernet node specific defaults");
        
        // Ethernet-specific initialization is handled by initializeDefaults() in entity constructor
        
        LOGGER.debug("Ethernet node initialization complete");
    }
