...
/**
 * Service class for CBabNodeModbus entity. 
 * Provides business logic for Modbus communication node management.
...
public class CBabNodeModbusService extends CBabNodeService<CBabNodeModbus> implements IEntityRegistrable, IEntityWithView {
    ...
    @Override
    public Class<CBabNodeModbus> getEntityClass() {
        return CBabNodeModbus.class;
    }
    ...
    @Override
    public void initializeNewEntity(final CBabNodeModbus entity) {
        super.initializeNewEntity(entity);
        LOGGER.debug("Initializing Modbus node specific defaults");
        
        // Modbus-specific initialization is handled by initializeDefaults() in entity constructor
        
        LOGGER.debug("Modbus node initialization complete");
    }
