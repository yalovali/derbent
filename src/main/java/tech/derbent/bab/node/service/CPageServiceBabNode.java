...
/** Page service for CBabNode hierarchy. Following Derbent pattern: Page service extends CPageServiceDynamicPage. Abstract base for concrete node type
 * page services (CAN, Ethernet, Modbus, ROS). */
