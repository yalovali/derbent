...
public class CBabNodeInitializerService extends CEntityOfCompanyInitializerService {
	...
	public static CGridEntity createGridEntity(final CProject<?> project) {
		...
		grid.setColumnFields(List.of("id", "name", "description", "device", "nodeType", "enabled", "nodeStatus",
				"portNumber", "company", "createdBy", "active", "createdDate", "lastModifiedDate"));
		return grid;
	}
