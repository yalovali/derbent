...
/**
 * Page service for CBabNodeCAN entity.
 * Following Derbent pattern: Concrete page service for CAN Bus node views.
 * Provides UI action handling and component lifecycle for CAN node views.
 */
