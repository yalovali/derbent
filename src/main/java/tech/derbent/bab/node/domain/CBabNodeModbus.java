...
/**
 * CBabNodeModbus - Modbus RTU/TCP communication node.
...
public class CBabNodeModbus extends CBabNode {
	...
	@Size(max = 10)
	@AMetaData(
		displayName = "Protocol", required = false, readOnly = false, 
		description = "Modbus protocol type (RTU or TCP)", hidden = false, maxLength = 10
	)
	private String protocolType;

	@Column(name = "slave_id", nullable = true)
	@AMetaData(
		displayName = "Slave ID", required = false, readOnly = false, 
		description = "Modbus slave/unit ID", hidden = false
	)
	private Integer slaveId;

	@Column(name = "baud_rate", nullable = true)
	@AMetaData(
		displayName = "Baud Rate", required = false, readOnly = false, 
		description = "Serial baud rate for RTU", hidden = false
	)
	...
	@Size(max = 10)
	@AMetaData(
		displayName = "Parity", required = false, readOnly = false, 
		description = "Serial parity (None, Even, Odd)", hidden = false, maxLength = 10
	)
	...
	@Size(max = 100)
	@AMetaData(
		displayName = "Host", required = false, readOnly = false, 
		description = "TCP host address", hidden = false, maxLength = 100
	)
