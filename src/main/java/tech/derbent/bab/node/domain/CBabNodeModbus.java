 ...
 * Handles Modbus protocol configuration and communication.
 */
@Entity
...
public class CBabNodeModbus extends CBabNode {
	...
	@Size(max = 10)
	@AMetaData(displayName = "Parity", required = false, readOnly = false, description = "Serial parity (None, Even, Odd)", hidden = false, maxLength = 10)
	...
	public CBabNodeModbus(final String name, final CBabDevice device) {
		super((Class) CBabNodeModbus.class, name, device, "Modbus");
	}
