...
public class Check {
	...
	public static void lengthRange(final String string, final int minLength, final int maxLength, final String message) {
		...
		if ((length < minLength) || (length > maxLength)) {
			final String defaultMessage = String.format("String length %d is not between %d and %d (inclusive)", length, minLength, maxLength);
			throw new IllegalArgumentException(message != null ? message : defaultMessage);
		}
	}
	...
	public static void maxLength(final String string, final int maxLength, final String message) {
		...
		if (string.length() > maxLength) {
			final String defaultMessage = String.format("String length %d exceeds maximum allowed %d", string.length(), maxLength);
			throw new IllegalArgumentException(message != null ? message : defaultMessage);
		}
	}
	...
	public static void maxSize(final Collection<?> collection, final int maxSize, final String message) {
		...
		if (collection.size() > maxSize) {
			final String defaultMessage = String.format("Collection size %d exceeds maximum allowed %d", collection.size(), maxSize);
			throw new IllegalArgumentException(message != null ? message : defaultMessage);
		}
	}
	...
	public static void minLength(final String string, final int minLength, final String message) {
		...
		if (string.length() < minLength) {
			final String defaultMessage = String.format("String length %d is less than minimum required %d", string.length(), minLength);
			throw new IllegalArgumentException(message != null ? message : defaultMessage);
		}
	}
	...
	public static void minSize(final Collection<?> collection, final int minSize, final String message) {
		...
		if (collection.size() < minSize) {
			final String defaultMessage = String.format("Collection size %d is less than minimum required %d", collection.size(), minSize);
	...
	public static void sizeRange(final Collection<?> collection, final int minSize, final int maxSize, final String message) {
		...
		if ((size < minSize) || (size > maxSize)) {
			final String defaultMessage = String.format("Collection size %d is not between %d and %d (inclusive)", size, minSize, maxSize);
			throw new IllegalArgumentException(message != null ? message : defaultMessage);
		}
	}
}
