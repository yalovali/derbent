...
public class Check {
    ...
    public static void checkPositive(final Number number, final String message) {
        ...
        if (number.doubleValue() <= 0) {
            throw new IllegalArgumentException(message != null ? message : "Number must be positive");
        }
    }
     ...
     * @throws IllegalArgumentException
     *             if number is outside the range
     */
    ...
    public static void checkRange(final Number number, final Number min, final Number max, final String message) {
        ...
        if ((value < minValue) || (value > maxValue)) {
            final String defaultMessage = String.format("Number must be between %s and %s (inclusive)", min, max);
    ...
    public static void condition(final boolean condition, final String message) {
        ...
        if (!condition) {
            throw new IllegalArgumentException(message != null ? message : DEFAULT_CONDITION_MESSAGE);
        }
    }
     ...
     * @throws IllegalArgumentException
     *             if collection doesn't contain the element
     */
    ...
    public static void contains(final Collection<?> collection, final Object element, final String message) {
        ...
        if (!collection.contains(element)) {
            final String defaultMessage = String.format("Collection does not contain element: %s", element);
            throw new IllegalArgumentException(message != null ? message : defaultMessage);
        }
    }
     ...
     * @throws IllegalArgumentException
     *             if string doesn't contain the substring
     */
    ...
    public static void contains(final String string, final String substring, final String message) {
        ...
        if (!string.contains(substring)) {
            final String defaultMessage = String.format("String '%s' does not contain '%s'", string, substring);
            throw new IllegalArgumentException(message != null ? message : defaultMessage);
        }
    }
    ...
    public static void equals(final Object obj1, final Object obj2, final String message) {
        ...
        if ((obj1 == null) || (obj2 == null) || !obj1.equals(obj2)) {
            final String defaultMessage = String.format("Objects are not equal: %s != %s", obj1, obj2);
            throw new IllegalArgumentException(message != null ? message : defaultMessage);
        }
    }
    ...
    public static void index(final int index, final int size, final String message) {
        ...
        if ((index < 0) || (index >= size)) {
            final String defaultMessage = String.format("Index %d is out of bounds for size %d", index, size);
            throw new IllegalArgumentException(message != null ? message : defaultMessage);
        }
    }
     ...
     * @throws IllegalArgumentException
     *             if object is not an instance of expectedClass
     */
    ...
    public static void instanceOf(final Object object, final Class<?> expectedClass, final String message) {
        ...
        if (!expectedClass.isInstance(object)) {
            final String defaultMessage = String.format("Object of type %s is not an instance of %s",
     ...
     * @throws IllegalArgumentException
     *             if string length is outside the range
     */
    ...
    public static void lengthRange(final String string, final int minLength, final int maxLength,
        ...
        condition(minLength <= maxLength, "Minimum length cannot be greater than maximum length");
        final int length = string.length();

        if ((length < minLength) || (length > maxLength)) {
            final String defaultMessage = String.format("String length %d is not between %d and %d (inclusive)", length,
                    minLength, maxLength);
            throw new IllegalArgumentException(message != null ? message : defaultMessage);
        }
    }
    ...
    public static void matches(final String string, final String regex, final String message) {
        ...
        if (!string.matches(regex)) {
            final String defaultMessage = String.format("String '%s' does not match pattern '%s'", string, regex);
            throw new IllegalArgumentException(message != null ? message : defaultMessage);
        }
    }
    ...
    public static void maxLength(final String string, final int maxLength, final String message) {
        ...
        if (string.length() > maxLength) {
            final String defaultMessage = String.format("String length %d exceeds maximum allowed %d", string.length(),
                    maxLength);
            throw new IllegalArgumentException(message != null ? message : defaultMessage);
        }
    }
     ...
     * @throws IllegalArgumentException
     *             if collection size exceeds maxSize
     */
    ...
    public static void maxSize(final Collection<?> collection, final int maxSize, final String message) {
        ...
        if (collection.size() > maxSize) {
            final String defaultMessage = String.format("Collection size %d exceeds maximum allowed %d",
     ...
     * @throws IllegalArgumentException
     *             if string is shorter than minLength
     */
    ...
    public static void minLength(final String string, final int minLength, final String message) {
        ...
        if (string.length() < minLength) {
            final String defaultMessage = String.format("String length %d is less than minimum required %d",
     ...
     * @throws IllegalArgumentException
     *             if collection size is less than minSize
     */
    ...
    public static void minSize(final Collection<?> collection, final int minSize, final String message) {
        ...
        if (collection.size() < minSize) {
            final String defaultMessage = String.format("Collection size %d is less than minimum required %d",
    ...
    public static void nonNegative(final Number number, final String message) {
        ...
        if (number.doubleValue() < 0) {
            throw new IllegalArgumentException(message != null ? message : "Number must be non-negative");
        }
    }
    ...
    public static void notBlank(final String string, final String message) {
        ...
        if (string.trim().isEmpty()) {
            throw new IllegalArgumentException(message != null ? message : DEFAULT_BLANK_MESSAGE);
        }
    }
    ...
    public static void notEmpty(final Collection<?> object, final String message) {
        ...
        if (object.isEmpty()) {
            throw new IllegalArgumentException(message != null ? message : DEFAULT_EMPTY_MESSAGE);
        }
    }
    ...
    public static void notEquals(final Object obj1, final Object obj2, final String message) {
        ...
        if (((obj1 == null) && (obj2 == null)) || ((obj1 != null) && obj1.equals(obj2))) {
            final String defaultMessage = String.format("Objects must not be equal: %s == %s", obj1, obj2);
            throw new IllegalArgumentException(message != null ? message : defaultMessage);
        }
    }
    ...
    public static void notNull(final Object object, final String message) {
        ...
        if (object == null) {
            throw new IllegalArgumentException(message != null ? message : DEFAULT_NULL_MESSAGE);
        }
    }
     ...
     *            the collection to check
     * @param minSize
     *            minimum required size (inclusive)
     * @param maxSize
     *            maximum allowed size (inclusive)
     * @throws IllegalArgumentException
     *             if collection size is outside the range
     */
    ...
    public static void sizeRange(final Collection<?> collection, final int minSize, final int maxSize,
        ...
        if ((size < minSize) || (size > maxSize)) {
            final String defaultMessage = String.format("Collection size %d is not between %d and %d (inclusive)", size,
                    minSize, maxSize);
            throw new IllegalArgumentException(message != null ? message : defaultMessage);
        }
    }
