...
/**
 * Utility class for handling enhanced validation errors and providing detailed error reporting for form binding
 * operations.
 */
public class CValidationUtils {
    ...
    /**
     * Handles validation exceptions with enhanced error reporting. Shows detailed field-level errors if using an
     * enhanced binder.
     * 
     * @param binder
     *            the binder that threw the exception
     * @param exception
     *            the validation exception
     * @param entityTypeName
     *            the name of the entity type for logging
     */
    public static void handleValidationException(final CEnhancedBinder<?> binder, final ValidationException exception,
     ...
     * 
     * @param enhancedBinder
     *            the enhanced binder with error details
     * @param entityTypeName
     *            the entity type name for context
     */
    public static void logDetailedErrors(final CEnhancedBinder<?> enhancedBinder, final String entityTypeName) {
        ...
        errors.forEach(
                (field, error) -> LOGGER.error("Field validation error - {}: {}", formatFieldName(field), error));
    }
     ...
     *            the entity type name for context
     */
    public static void showEnhancedValidationDialog(final CEnhancedBinder<?> enhancedBinder,
            final String entityTypeName) {
     ...
     *            the entity type name for context
     */
    public static void showEnhancedValidationNotification(final CEnhancedBinder<?> enhancedBinder,
            final String entityTypeName) {
        ...
        final String message = String.format("Validation failed for %s in %d field(s): %s", entityTypeName,
