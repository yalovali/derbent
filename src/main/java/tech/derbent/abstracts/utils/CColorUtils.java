 ...
 * 
 * <p>
 * This utility class provides common methods for extracting colors from status entities, calculating contrast text
 * colors, and applying color styling to UI components.
 * </p>
 * 
 * <p>
 * The class follows the project's coding guidelines by centralizing color-related logic and providing reusable methods
 * for color-aware components.
 * </p>
 * 
...
public final class CColorUtils {
    ...
    /**
     * Checks if an entity type is a status entity (extends CStatus or CTypeEntity). Uses reflection to determine
    ...
    public static boolean isStatusEntity(final Class<?> entityType) {
        ...
        try {
            ...
            LOGGER.warn("Error checking if entity type {} is a status entity: {}", entityType.getSimpleName(),
                    e.getMessage());
            return false;
        }
    }
    ...
    /**
     * Extracts color from an entity using reflection. Supports entities that extend CTypeEntity (which have getColor()
     * method).
     * 
     * @param entity
     *            the entity instance to extract color from
    ...
    public static String getColorFromEntity(final Object entity) {
        ...
        try {
            ...
            LOGGER.warn("Error extracting color from entity {}: {}", entity.getClass().getSimpleName(), e.getMessage());
            return null;
        }
    }
     ...
     * 
     * @param entity
     *            the entity to get display text for
    ...
    /**
     * Determines appropriate text color based on background color. Uses a simple brightness calculation to determine if
     * white or black text would be more readable.
     * 
     * @param backgroundColor
     *            the background color in hex format (e.g., "#FF0000")
     ...
     * 
     * @param entity
     *            the entity to extract color from
     * @param defaultColor
     *            the default color to use if no color is found
    ...
    /**
     * Gets an appropriate icon for an entity based on its type. Now supports ALL entity types in the system with
     * specific icons.
     * 
     * @param entity
     *            the entity to get an icon for
    ...
    public static VaadinIcon getIconForEntity(final Object entity) {
        ...
        try {
            ...
            LOGGER.warn("Error determining icon for entity {}: {}", entity.getClass().getSimpleName(), e.getMessage());
            return VaadinIcon.RECORDS; // Safe fallback
        }
    }

    /**
     * Checks if an entity should have an icon displayed. Now returns true for all entities since all entities have
     * icons.
     * 
     * @param entity
     *            the entity to check
     ...
     * 
     * @param entity
     *            the entity to create an icon for
    ...
    /**
     * Applies color styling to a component using CSS styles. This is a helper method that can be used with any
     * component that has getStyle() method.
     * 
     * @param component
     *            the component to style (must have getStyle() method)
     * @param backgroundColor
     *            the background color
     * @param autoContrast
     *            whether to automatically calculate text color
     * @param padding
