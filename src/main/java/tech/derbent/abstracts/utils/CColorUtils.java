...
public final class CColorUtils {
	...
	/** Extracts color from an entity using reflection. Supports entities that extend CTypeEntity (which have getColor() method).
	...
	/** Gets an appropriate icon for an entity based on its type. Now supports ALL entity types in the system with specific icons.
	...
	/** Checks if an entity type is a status entity (extends CStatus or CTypeEntity). Uses reflection to determine inheritance hierarchy.
	...
	/** Checks if an entity should have an icon displayed. Now returns true for all entities since all entities have icons.
