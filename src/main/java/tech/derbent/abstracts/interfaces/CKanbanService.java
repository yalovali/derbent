...
/**
 * CKanbanService - Interface for services that provide data for Kanban boards.
 * Layer: Service Interface (Abstraction)
 * 
 * Provides the contract for services that can supply entities grouped by status
