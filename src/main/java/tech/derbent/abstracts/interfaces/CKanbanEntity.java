...
/**
 * CKanbanEntity - Interface for entities that can be displayed in a Kanban board.
 * Layer: Interface (Abstraction)
 * 
 * Any entity that implements this interface can be used in the generic kanban system.
 * Provides the basic contract for entities with status-based organization.
 */
