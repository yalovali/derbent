...
/**
 * CKanbanType - Interface for type entities used in Kanban boards.
 * Layer: Interface (Abstraction)
 * 
 * Provides the contract for type objects that can be used to group
 * entities within kanban columns.
 */
