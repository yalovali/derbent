...
/**
 * Interface for components that need to be notified when the active project changes.
 * Components implementing this interface will receive immediate notifications
