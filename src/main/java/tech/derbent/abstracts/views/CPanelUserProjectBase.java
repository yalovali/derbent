...
/**
 * Base class for managing user-project relationships in both directions. This class provides common functionality for
 * both user->project and project->user panels.
 */
public abstract class CPanelUserProjectBase<MasterClass extends CEntityNamed<MasterClass>, RelationalClass extends CEntityDB<RelationalClass>>
    ...
    public CPanelUserProjectBase(final String title, final MasterClass currentEntity,
            final CEnhancedBinder<MasterClass> beanValidationBinder, final Class<MasterClass> entityClass,
    ...
    protected void setupGrid() {
        ...
        grid.addColumn(CUserProjectSettings::getProjectName).setHeader("Project Name").setAutoWidth(true)
                .setSortable(true);
    ...
    /**
     * Common validation helper for entity selection in grid. Shows warning dialog and returns false if no item is
     * selected.
     * 
     * @param actionName
     *            Name of the action for error message (e.g., "edit", "delete")
    ...
    /**
     * Common validation helper for service availability. Shows warning dialog and returns false if service is
     * unavailable.
     * 
     * @param serviceName
     *            Name of the service for error message
