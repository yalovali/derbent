...
/**
 * CInformationDialog - Dialog for displaying informational messages to users. Layer: View (MVC) Used to provide helpful
 * information or confirmation of successful actions.
 */
