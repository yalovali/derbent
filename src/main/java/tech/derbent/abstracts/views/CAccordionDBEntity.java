...
public abstract class CAccordionDBEntity<EntityClass extends CEntityDB<EntityClass>> extends CAccordion {
    ...
    protected void createPanelContent() {
        ...
        getBaseLayout().add(CEntityFormBuilder.buildForm(entityClass, getBinder(), getEntityFields()));
    }
    ...
    public ComboBoxDataProvider getDetailsDataProvider() {
        return detailsDataProvider;
    }
