...
/**
 * CBaseDialog - Abstract base class for simple message dialogs. Layer: View (MVC) Provides common functionality for
 * warning, information, and exception dialogs. These dialogs are for showing messages to users, not for data editing.
 */
