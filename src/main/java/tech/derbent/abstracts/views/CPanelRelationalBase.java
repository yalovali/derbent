...
public abstract class CPanelRelationalBase<MasterClass extends CEntityDB<MasterClass>,
	...
	public CPanelRelationalBase(final String title, final MasterClass currentEntity,
		final CEnhancedBinder<MasterClass> beanValidationBinder,
		final Class<MasterClass> entityClass,
		final CAbstractService<MasterClass> masterService,
		final Class<RelationalClass> relationalClass) {
	 ...
	 */
	public void setSettingsAccessors(final Supplier<List<RelationalClass>> getSettings,
