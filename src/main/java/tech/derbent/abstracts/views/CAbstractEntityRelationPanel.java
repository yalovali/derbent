...
/**
 * Abstract base class for managing entity-to-entity relationships. This class provides
 * common functionality for panels that manage relationships between entities.
 ...
 */
public abstract class CAbstractEntityRelationPanel<
	ParentEntity extends CEntityDB<ParentEntity>,
	RelationEntity extends CEntityDB<RelationEntity>>
	...
	protected final Grid<RelationEntity> grid =
		new Grid<>(getRelationEntityClass(), false);
	 ...
	 */
	public CAbstractEntityRelationPanel(final String title,
		final ParentEntity currentEntity,
		final CEnhancedBinder<ParentEntity> beanValidationBinder,
		final Class<ParentEntity> entityClass,
	...
	protected abstract String
		createDeleteConfirmationMessage(final RelationEntity selected);
	...
	protected void deleteSelected() {
		...
		if ((getRelations == null) || (setRelations == null)) {
			new CWarningDialog(
				"Relationship handlers are not available. Please refresh the page.")
				.open();
			return;
		}
