...
/**
 * CButton - Abstract base class for all buttons in the application.
 * Layer: View (MVC)
 * Provides common initialization patterns, logging, and standardized button configurations.
 * Extends Vaadin Button with application-specific enhancements.
 */
public class CButton extends Button {
	 ...
	 * @return a new CButton with primary styling
	 */
	public static CButton createPrimary(final String text, final ComponentEventListener<ClickEvent<Button>> clickListener) {
	 ...
	 * @return a new CButton with tertiary styling
	 */
	public static CButton createTertiary(final String text, final ComponentEventListener<ClickEvent<Button>> clickListener) {
		final CButton button = new CButton(text, clickListener);
		button.addThemeVariants(ButtonVariant.LUMO_TERTIARY);
		return button;
	}
	 ...
	 * @return a new CButton with error styling
	 */
	public static CButton createError(final String text, final ComponentEventListener<ClickEvent<Button>> clickListener) {
		final CButton button = new CButton(text, clickListener);
		button.addThemeVariants(ButtonVariant.LUMO_ERROR);
		return button;
	}
	...
	/**
	 * Common initialization for all CButton instances.
	 * This method can be overridden by subclasses to provide additional initialization.
	 */
