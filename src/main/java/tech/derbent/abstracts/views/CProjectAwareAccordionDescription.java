...
public abstract class CProjectAwareAccordionDescription<EntityClass extends CEntityDB>
    ...
    /**
     * Called when the active project changes. Implementations should refresh their content
    ...
    /**
     * Refreshes the panel content for a project change. Default implementation clears
     * the base layout and recreates content. Subclasses can override for custom behavior.
    ...
    /**
     * Determines if the panel should refresh based on the entity and new project.
     * Default implementation always returns true. Subclasses can override for specific logic.
