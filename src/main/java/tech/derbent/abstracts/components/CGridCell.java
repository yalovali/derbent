 ...
 * <p>
 * This class provides a unified foundation for all grid cell components, supporting: - Regular text display -
 * Color-aware status rendering with background colors - Optional icon display for entities - Consistent styling and
 * behavior
 * </p>
 * <p>
 * The class follows the project's coding guidelines by consolidating all cell functionality into a single, reusable
 * component that uses Div for proper layout control.
 * </p>
 * <p>
...
public class CGridCell extends Div {
     ...
     * 
     * @param entity
     *            the entity to display in the cell
     */
    ...
    /**
     * Set status entity value with color-aware rendering and optional icon display. This method provides the same
     * functionality as the removed CGridCellStatus.
     * 
     * @param statusEntity
     *            the status entity to display
     */
     ...
     * 
     * @param entity
     *            the entity providing the color
     * @param color
    ...
    /**
     * Set boolean value with custom styling for true/false states. This method provides consistent styling for
     * boolean-based grid cells.
     * 
     * @param value
     ...
     * @param falseText
     *            text to display when value is false (can be empty)
     * @param trueColor
     *            background color for true state
     * @param falseColor
     *            background color for false state (can be null for no background)
     */
    ...
    /**
     * Set boolean value with predefined Final/Active styling. This is a convenience method for common Final/Active
     * status display.
     * 
     * @param isFinal
     *            true if the status is final, false if active
     */
     ...
     * 
     * @param isDefault
     *            true if this is the default item
     */
