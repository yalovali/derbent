...
/**
 * CSearchToolbar - A reusable search toolbar component with debounced text input.
 * Layer: View (MVC)
 * 
 * Provides a text field for live searching with configurable debounce delay to avoid
 * excessive search requests while the user is typing. Follows the project's coding
 * guidelines for component styling and behavior.
 * 
