...
public abstract class CAbstractService<EntityClass extends CEntityDB<EntityClass>> {
    ...
    public void initializeLazyFields(final EntityClass entity) {
        ...
        try {
            ...
            LOGGER.warn("Error initializing lazy fields for {} with ID: {}", entity.getClass().getSimpleName(),
                    entity.getId(), e);
        }
    }
    ...
    /**
     * Lists entities with text-based filtering for searchable entities. This method works with entities that implement
     * CSearchable interface.
     * 
     * @param pageable
     *            pagination information
     * @param searchText
     *            text to search for (null or empty means no filtering)
     ...
     * @param updatedEntity
     *            entity containing the new values
