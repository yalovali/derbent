...
/**
 * CAbstractService - Abstract base service class for entity operations. Layer:
 * Service (MVC) Provides common CRUD operations and lazy loading support for
 * all entity types.
 */
public abstract class CAbstractService<EntityClass extends CEntityDB> {
	 ...
	 * Subclasses can override this method to specify which fields need
	 * initialization. This base implementation automatically handles
