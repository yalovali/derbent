...
/**
 * CAbstractNamedRepository - Abstract repository interface for entities that extend CEntityNamed. Layer: Service (MVC)
 * - Repository interface Provides common query methods for named entities with case-insensitive operations.
 */
@NoRepositoryBean
