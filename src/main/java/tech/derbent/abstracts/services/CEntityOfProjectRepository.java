 ...
 * CEntityOfProject. Layer: Service (MVC) - Repository interface
 * Provides common query methods for project-aware entities with proper lazy loading
...
public interface CEntityOfProjectRepository<EntityClass extends CEntityOfProject>
     ...
     * CEntityOfProject repositories should use unless they need additional
     ...
     * LazyInitializationException. This base implementation loads common
     * CEntityOfProject relationships.
     * 
