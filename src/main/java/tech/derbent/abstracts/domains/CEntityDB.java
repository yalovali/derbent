...
public abstract class CEntityDB<EntityClass> extends CEntity<EntityClass> implements CInterfaceIconSet {
    ...
    /**
     * Generic method to copy non-null fields from source to target using reflection. This method handles update
     * operations by copying only the fields that have values.
     * 
     * @param source
     *            the source entity with updated values
     * @param target
    ...
    public void copyNonNullFields(final EntityClass source, final EntityClass target) {
        ...
        try {
            ...
            LOGGER.debug("Successfully copied non-null fields from {} to {}", source.getClass().getSimpleName(),
    ...
    /**
     * Generic method to save entity state using reflection. This method can be overridden by subclasses for custom save
     * behavior.
     * 
    ...
    /**
     * Generic method to perform soft delete using reflection. Looks for common soft delete fields like 'deleted',
     * 'active', 'enabled'.
     * 
    ...
    /**
     * Helper method to update audit fields using reflection. Looks for common audit fields like 'lastModifiedDate',
     * 'updatedAt'.
     */
