...
/**
 * CTypeEntity - Abstract base class for all type entities in the system. Provides common fields for type management
 * including color, sort order, and active status. Layer: Domain (MVC)
 * 
 * @author Derbent Team
 * @since 1.0
 */
