...
/**
 * ColorAwareGrid annotation for Grid columns that should display status entities with colored backgrounds.
 * This annotation is used to mark methods in Grid view classes that should create color-aware status columns.
 * 
 * <p>
 * This annotation is typically used on methods that add status columns to grids, enabling automatic
 * color rendering based on the status entity's color property.
 * </p>
 * 
 * <p>
 ...
 * </p>
 * <ul>
 * <li>The status entity must extend {@link tech.derbent.base.domain.CStatus} or {@link tech.derbent.abstracts.domains.CTypeEntity}</li>
