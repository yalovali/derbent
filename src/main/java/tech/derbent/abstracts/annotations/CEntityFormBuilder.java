...
public final class CEntityFormBuilder implements ApplicationContextAware {
    ...
    public static <EntityClass> Div buildForm(final Class<?> entityClass,
        ...
        for (final Field field : sortedFields) {
            ...
            processedComponents = processMetaForField(binder, dataProvider, formLayout, processedComponents, field);
        }
    ...
    private static NumberField createBigDecimalField(final Field field, final MetaData meta,
        ...
        if ((field == null) || (meta == null) || (binder == null)) {
            LOGGER.error("Null parameters in createIntegerField - field: {}, meta: {}, binder: {}",
        ...
        binder.forField(numberField).withConverter(value -> value != null ? new BigDecimal(value.toString()) : null,
                value -> value != null ? value.doubleValue() : null).bind(propertyName);
        return numberField;
    }
    ...
    @SuppressWarnings("unchecked")
    private static <T extends CEntityDB<T>> ComboBox<T> createComboBox(final Field field, final MetaData meta,
        ...
        final tech.derbent.abstracts.annotations.ColorAwareComboBox colorAnnotation = field
                .getAnnotation(tech.derbent.abstracts.annotations.ColorAwareComboBox.class);
        ...
        if ((colorAnnotation != null) || tech.derbent.abstracts.utils.CColorUtils.isStatusEntity(fieldType)) {
            ...
            final tech.derbent.abstracts.components.CColorAwareComboBox<T> colorAwareComboBox = new tech.derbent.abstracts.components.CColorAwareComboBox<>(
                    fieldType);
        ...
        if (dataProvider != null) {
            ...
            try {
                ...
                if (items != null) {
                    ...
                    LOGGER.warn("Legacy data provider returned null for field '{}' of type '{}'", field.getName(),
                            fieldType.getSimpleName());
                }
            } catch (final Exception e) {
                LOGGER.error("Error using legacy data provider for field '{}' of type '{}': {}", field.getName(),
                        fieldType.getSimpleName(), e.getMessage(), e);
            }
        }
        ...
        if ((items == null) && (dataProviderResolver != null)) {
            ...
            try {
                ...
                if (items != null) {
                    ...
                    LOGGER.warn("Annotation-based resolver returned null for field '{}' of type '{}'", field.getName(),
                            fieldType.getSimpleName());
                }
            } catch (final Exception e) {
        ...
        try {
            ...
            if (!items.isEmpty() && ((meta.defaultValue() == null) || meta.defaultValue().trim().isEmpty())) {
                ...
                LOGGER.debug("Set ComboBox default value to first item for field '{}': {}", field.getName(),
                        items.get(0));
            }
        } catch (final Exception e) {
    ...
    private static Component createComponentForField(final Field field, final MetaData meta,
        ...
        if (component == null) {
            LOGGER.error("Component creation failed for field '{}' of type '{}'", field.getName(),
                    fieldType.getSimpleName());
            return null;
        }
    ...
    private static DatePicker createDatePicker(final Field field, final MetaData meta,
        ...
        try {
            ...
            LOGGER.error("Error binding DatePicker for field '{}': {}", field.getName(), e.getMessage(), e);
        }
        return datePicker;
    }
    ...
    private static NumberField createFloatingPointField(final Field field, final MetaData meta,
        ...
        if ((field == null) || (meta == null) || (binder == null)) {
            LOGGER.error("Null parameters in createFloatingPointField - field: {}, meta: {}, binder: {}",
                    field != null ? field.getName() : "null", meta != null ? "present" : "null",
                    binder != null ? "present" : "null");
            return null;
        }
    ...
    private static NumberField createIntegerField(final Field field, final MetaData meta,
        ...
        if ((meta.defaultValue() != null) && !meta.defaultValue().trim().isEmpty()) {
            ...
            try {
                final double defaultVal = Double.parseDouble(meta.defaultValue());
                numberField.setValue(defaultVal);
                LOGGER.debug("Set default value '{}' for integer field '{}'", defaultVal, field.getName());
            } catch (final NumberFormatException e) {
                LOGGER.error("Failed to parse default value '{}' as number for field '{}': {}", meta.defaultValue(),
                        field.getName(), e.getMessage());
            }
        ...
        try {
            ...
            LOGGER.error("Failed to bind integer field for field '{}': {} - trying simple binding", field.getName(),
                    e.getMessage());
            safeBindComponentWithField(binder, numberField, field, "NumberField");
        }
        return numberField;
    ...
    private static TextArea createTextArea(final Field field, final MetaData meta,
        ...
        if ((field == null) || (meta == null) || (binder == null)) {
            LOGGER.error("Null parameters in createTextArea - field: {}, meta: {}, binder: {}",
                    field != null ? field.getName() : "null", meta != null ? "present" : "null",
                    binder != null ? "present" : "null");
            return null;
        }
    ...
    private static <EntityClass> int processMetaForField(final BeanValidationBinder<EntityClass> binder,
            final ComboBoxDataProvider dataProvider, final VerticalLayout formLayout, int processedComponents,
            final Field field) {
     ...
     */
    /**
     * Determines the correct property name for binding.
     * Simply returns the field name for most cases.
     */
    ...
    private static void safeBindComponent(final BeanValidationBinder<?> binder,
            final HasValueAndElement<?, ?> component, final String fieldName, final String componentType) {
     ...
     */
    private static void safeBindComponentWithField(final BeanValidationBinder<?> binder,
    ...
    private static void setRequiredIndicatorVisible(final MetaData meta, final Component field) {
        ...
        if ((field == null) || (meta == null) || ((field instanceof HasValueAndElement) == false)) {
