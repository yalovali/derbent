...
public final class CEntityFormBuilder implements ApplicationContextAware {
                ...
                entityValue -> {
                    ...
                    try {
                        ...
                        if (matchingItem != null) {
                            ...
                            LOGGER.warn("No matching ComboBox item found for entity ID {} in field '{}'", entityId,
                                    field.getName());
                        }
                        return matchingItem;
                    } catch (final Exception e) {
                        LOGGER.error("Error converting entity to ComboBox value for field '{}': {}", field.getName(),
                                e.getMessage(), e);
                        return null;
                    }
                }).bind(field.getName());
    ...
    private static Component createComponentForField(final Field field, final MetaData meta,
        ...
        if ((fieldType == Boolean.class) || (fieldType == boolean.class)) {
            ...
            component = createIntegerField(field, meta, binder);
                ...
                || (fieldType == float.class) || (fieldType == BigDecimal.class)) {
    ...
    private static NumberField createFloatingPointField(final Field field, final MetaData meta,
        ...
        try {
            ...
            if ((fieldType == Float.class) || (fieldType == float.class)) {
                binder.forField(numberField).withConverter(value -> value != null ? value.floatValue() : null,
            ...
            LOGGER.error("Failed to bind floating point field for field '{}': {}", field.getName(), e.getMessage());
            return null;
        }
        return numberField;
    }
    ...
    private static NumberField createIntegerField(final Field field, final MetaData meta,
        ...
        try {
            ...
            LOGGER.error("Failed to bind integer field for field '{}': {}", field.getName(), e.getMessage());
            return null;
        }
        return numberField;
    }
    ...
    private static void setHelperText(final MetaData meta, final Component component) {
        ...
        if ((component == null) || (meta == null) || ((component instanceof HasHelper) == false)) {
