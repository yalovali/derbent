...
/**
 * StatusEntity annotation to mark entity classes as status entities that have color properties.
 * This annotation is used to identify entities that represent statuses and should be rendered
 * with color-aware components.
 * 
 * <p>
 * This annotation enables automatic detection of status entities by the form builder and grid
 * components, allowing them to apply appropriate color rendering without manual configuration.
 * </p>
 * 
 * <p>
...
public @interface StatusEntity {
    ...
    /**
     * The category or type of status this entity represents.
     * This can be used for grouping or filtering status entities.
     * 
    ...
    /**
     * Whether this status entity represents final states.
     * Final states typically represent completed or terminated statuses.
     * 
