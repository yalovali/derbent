...
/**
 * CCompanyService - Business logic layer for CCompany entities Layer: Service (MVC) Extends CAbstractService to provide
 * standard CRUD operations with additional business logic
 */
@Service
...
public class CCompanyService extends CAbstractNamedEntityService<CCompany> {
     ...
     * 
     * @param repository
     *            the CCompanyRepository instance
     * @param clock
    ...
    @Override
    protected Class<CCompany> getEntityClass() {
