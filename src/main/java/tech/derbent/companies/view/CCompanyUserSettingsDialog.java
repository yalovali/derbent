...
public class CCompanyUserSettingsDialog extends CDBRelationDialog<CUserCompanySetting, CCompany, CUser> {
	...
	public CCompanyUserSettingsDialog(IContentOwner parentContent, final CCompanyService masterService, final CUserService detailService,
		...
		super(parentContent, settings != null ? settings : new CUserCompanySetting(), company, masterService, detailService, relationService, onSave,
				settings == null);
