...
/**
 * CCompanyView - View for managing companies Layer: View (MVC) Provides CRUD operations for CCompany entities with
...
public class CCompanyView extends CAbstractNamedEntityPage<CCompany> implements CInterfaceIconSet {
    ...
    public static String getIconFilename() {
        return CCompany.getIconFilename();
    }
     ...
     * 
     * @param companyId
     *            the ID of the company to view (null for list view)
     */
