...
/**
 * CPanelCompanyBase - Abstract base class for all CCompany-related accordion panels. Layer: View (MVC) Provides common
 * functionality for company entity panels following the same pattern as CPanelActivityBase.
 */
