...
/**
 * CPanelCompanySystemStatus - Panel for grouping system status and administrative fields of CCompany entity. Layer:
 * View (MVC) Groups fields: enabled, taxNumber
 */
public class CPanelCompanySystemStatus extends CPanelCompanyBase {

    private static final long serialVersionUID = 1L;

    public CPanelCompanySystemStatus(final CCompany currentEntity, final CEnhancedBinder<CCompany> beanValidationBinder,
