...
/**
 * CMeetingKanbanBoardView - Kanban board view for meetings using the generic base
 * classes. Layer: View (MVC) This implementation demonstrates how the generic kanban
 * system can be used for different entity types like meetings.
 */
@Route ("meetings-kanban")
@PageTitle ("Meeting Kanban Board")
@Menu (
	order = 3.1, icon = "class:tech.derbent.kanban.view.CMeetingKanbanBoardView",
	title = "Meetings.Kanban"
)
@PermitAll
public class CMeetingKanbanBoardView
	extends CBaseKanbanBoardView<CMeeting, CMeetingStatus> implements CInterfaceIconSet {

	private static final long serialVersionUID = 1L;

	private static final Logger LOGGER =
		LoggerFactory.getLogger(CMeetingKanbanBoardView.class);
	 ...
	 */
	public CMeetingKanbanBoardView(final CMeetingService meetingService,
	...
	@Override
	protected CBaseKanbanColumn<CMeeting, CMeetingStatus>
		createKanbanColumn(final CMeetingStatus status, final List<CMeeting> entities) {
