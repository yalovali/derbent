...
/**
 * CCompanySettingsView - View for managing company-wide administration settings. Layer: View (MVC) Provides a
 * comprehensive interface for administrators to configure company-wide settings including workflow defaults, working
 * hours, notifications, project management preferences, and UI customizations. Each company has one settings record.
 */
...
public class CCompanySettingsView extends CAbstractEntityDBPage<CCompanySettings> {
     ...
     * 
     * @param entityService
     *            the CCompanySettingsService instance
    ...
    /**
     * Creates the entity details form using MetaData annotations. The form is automatically generated based on the
     * CCompanySettings entity annotations.
     */
    @Override
    ...
    protected void createGridForEntity() {
        ...
        try {
            ...
            grid.addReferenceColumn(settings -> settings.getCompany() != null ? settings.getCompany().getName() : "",
                    "Company");
            grid.addShortTextColumn(CCompanySettings::getDefaultProjectStatus, "Default Project Status",
            ...
            grid.addBooleanColumn(CCompanySettings::isEmailNotificationsEnabled, "Email Notifications", "Enabled",
                    "Disabled");
