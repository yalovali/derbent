 ...
 * Layer: Domain (MVC)
 * 
 * This entity stores administrative configurations that apply across all projects
 * within a specific company, including workflow defaults, working hours, notifications,
 * and project management preferences.
 */
@Entity
...
public final class CCompanySettings extends CEntityDB {
    ...
    @MetaData(displayName = "Company", required = true, readOnly = false, 
              description = "Company these settings belong to", hidden = false, order = 1)
    private CCompany company;

    // Workflow and Project Management Settings
    @Column(name = "default_project_status", nullable = false, length = MAX_LENGTH_NAME)
    @Size(max = MAX_LENGTH_NAME)
    @MetaData(displayName = "Default Project Status", required = true, readOnly = false, 
    ...
    @Column(name = "default_activity_status", nullable = false, length = MAX_LENGTH_NAME)
    @Size(max = MAX_LENGTH_NAME)
    @MetaData(displayName = "Default Activity Status", required = true, readOnly = false, 
              defaultValue = "TODO", description = "Default status for new activities", 
              hidden = false, order = 3, maxLength = MAX_LENGTH_NAME)
    private String defaultActivityStatus = "TODO";

    @Column(name = "default_activity_priority", nullable = false, length = MAX_LENGTH_NAME)
    @Size(max = MAX_LENGTH_NAME)
    @MetaData(displayName = "Default Activity Priority", required = true, readOnly = false, 
    ...
    @Column(name = "company_timezone", nullable = false, length = MAX_LENGTH_NAME)
    @Size(max = MAX_LENGTH_NAME)
    @MetaData(displayName = "Company Timezone", required = true, readOnly = false, 
              defaultValue = "UTC", description = "Primary timezone for the company", 
              hidden = false, order = 5, maxLength = MAX_LENGTH_NAME)
    ...
    @MetaData(displayName = "Working Hours Per Day", required = true, readOnly = false, 
    ...
    @MetaData(displayName = "Working Days Per Week", required = true, readOnly = false, 
    ...
    @MetaData(displayName = "Start Work Hour", required = true, readOnly = false, 
    ...
    @MetaData(displayName = "End Work Hour", required = true, readOnly = false, 
    ...
    @MetaData(displayName = "Email Notifications", required = true, readOnly = false, 
              defaultValue = "true", description = "Enable email notifications", 
    ...
    @MetaData(displayName = "Due Date Reminder (Days)", required = true, readOnly = false, 
    ...
    @MetaData(displayName = "Overdue Notifications", required = true, readOnly = false, 
    ...
    @MetaData(displayName = "Auto-assign Project Manager", required = true, readOnly = false, 
              defaultValue = "false", description = "Automatically assign project manager to new projects", 
              hidden = false, order = 13)
    private boolean autoAssignProjectManager = false;

    @Column(name = "require_time_tracking", nullable = false)
    @MetaData(displayName = "Require Time Tracking", required = true, readOnly = false, 
    ...
    @MetaData(displayName = "Default Hourly Rate", required = false, readOnly = false, 
    ...
    @Size(max = 7)
    @MetaData(displayName = "Theme Color", required = false, readOnly = false, 
    ...
    @MetaData(displayName = "Show Budget Information", required = true, readOnly = false, 
              defaultValue = "true", description = "Display budget information in project views", 
              hidden = false, order = 17)
    private boolean showBudgetInfo = true;

    @Column(name = "enable_gantt_charts", nullable = false)
    @MetaData(displayName = "Enable Gantt Charts", required = true, readOnly = false, 
    ...
    @Column(name = "default_user_role", nullable = false, length = MAX_LENGTH_NAME)
    @Size(max = MAX_LENGTH_NAME)
    @MetaData(displayName = "Default User Role", required = true, readOnly = false, 
              defaultValue = "MEMBER", description = "Default role for new users", 
              hidden = false, order = 19, maxLength = MAX_LENGTH_NAME)
    private String defaultUserRole = "MEMBER";

    @Column(name = "require_approval_for_time_entries", nullable = false)
    @MetaData(displayName = "Require Time Entry Approval", required = true, readOnly = false, 
    ...
    public String toString() {
        return "CCompanySettings{" +
                "company=" + (company != null ? company.getName() : "null") +
                ", defaultProjectStatus='" + defaultProjectStatus + '\'' +
                ", defaultActivityStatus='" + defaultActivityStatus + '\'' +
                ", defaultActivityPriority='" + defaultActivityPriority + '\'' +
