...
/**
 * CPanelActivityComments - Accordion panel for managing comments on activities. Layer: View (MVC) Provides UI for: -
 * Viewing existing comments in chronological order - Adding new comments - Comment count display - Integration with
...
public class CPanelActivityComments extends CPanelActivityBase {
     ...
     *            the session service
     */
    public CPanelActivityComments(final CActivity currentEntity, final BeanValidationBinder<CActivity> binder,
    ...
    private void addComment() {
        ...
        try {
            ...
            final CComment newComment = commentService.createComment(commentText.trim(), getCurrentEntity(),
                    currentUser);
