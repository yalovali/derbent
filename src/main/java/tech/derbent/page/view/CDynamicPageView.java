...
/**
 * Dynamic page view for rendering database-defined pages.
 * This view displays content stored in CPageEntity instances.
 */
@PermitAll
public class CDynamicPageView extends VerticalLayout implements BeforeEnterObserver {
	...
	private void createDefaultContent(Div contentArea) {
		...
		Paragraph welcomeText = new Paragraph(
			...
			"Content can be customized through the page management system."
		);
		
		if (pageEntity.getProject() != null) {
			Paragraph projectInfo = new Paragraph(
				"This page belongs to project: " + pageEntity.getProject().getName()
			);
	...
	private void addOverviewContent(Div contentArea) {
		...
		Paragraph content = new Paragraph(
			"This section provides a comprehensive overview of the project objectives, " +
	...
	private void addDirectoryContent(Div contentArea) {
		...
		Paragraph content = new Paragraph(
			"Here you can find contact information for all team members, " +
	...
	private void addLibraryContent(Div contentArea) {
		...
		Paragraph content = new Paragraph(
			"This area contains important project documents, reference materials, " +
	...
	private void addGenericContent(Div contentArea) {
		...
		Paragraph content = new Paragraph(
			"This page is ready for custom content. You can edit this page " +
	...
	private void createPageFooter() {
		...
		if (pageEntity.getLastModifiedDate() != null) {
			Paragraph lastModified = new Paragraph(
				"Last updated: " + pageEntity.getLastModifiedDate().toString()
			);
	 ...
	 * In a production system, use a proper HTML sanitization library.
	 */
	 ...
	 */
	public CPageEntity getPageEntity() {
		return pageEntity;
	}
}