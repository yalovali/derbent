...
/** Service for managing dynamic pages and their integration with the menu system. Handles both lazy and eager loading strategies for database-defined
 * pages. */
@Service
public class CPageService {
	...
	private final boolean eagerLoadingEnabled = Boolean.parseBoolean(System.getProperty("derbent.pages.eager-loading", "false"));

	public CPageService(final CPageEntityService pageEntityService, final CSessionService sessionService) {
		this.pageEntityService = pageEntityService;
		this.sessionService = sessionService;
		LOGGER.info("CPageService initialized with {} loading strategy", eagerLoadingEnabled ? "eager" : "lazy");
	}

	/** Get all database-defined pages for the current project to populate the menu. This method is used by MainLayout to generate dynamic menu
	 * items. */
	...
	/** Create or retrieve a page instance for the given route. Used when a user navigates to a database-defined page. */
	...
	/** Get hierarchical page structure for a project. Used for building nested menu structures. */
	...
	public boolean isEagerLoadingEnabled() { return eagerLoadingEnabled; }

	/** Get current cache size (for monitoring). */
	public int getCacheSize() { return pageInstanceCache.size(); }
