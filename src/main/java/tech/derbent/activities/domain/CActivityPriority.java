 ...
 * Provides predefined priority levels for activity categorization and workflow management.
 * Layer: Domain (MVC)
 * 
 * Standard priority levels: CRITICAL, HIGH, MEDIUM, LOW, LOWEST
 * 
 * @author Derbent Team
 * @since 1.0
 */
...
public class CActivityPriority extends CTypeEntity {
    ...
    public CActivityPriority() {
        super();
        LOGGER.debug("CActivityPriority default constructor called");
    }
    ...
    public CActivityPriority(final String name, final CProject project, 
        ...
        LOGGER.debug("CActivityPriority constructor called with name: {}, project: {}, color: {}, sortOrder: {}", 
