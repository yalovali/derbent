...
/**
 * CActivityPriority - Domain entity representing activity priority levels. Provides predefined priority levels for
 * activity categorization and workflow management. Layer: Domain (MVC) Standard priority levels: CRITICAL, HIGH,
 * MEDIUM, LOW, LOWEST
 * 
 * @author Derbent Team
 * @since 1.0
...
public class CActivityPriority extends CTypeEntity<CActivityPriority> {
    ...
    @MetaData(displayName = "Priority Level", required = false, readOnly = false, defaultValue = "3", description = "Priority level (1=Highest, 5=Lowest)", hidden = false, order = 2)
     ...
     * 
     * @param name
     *            the name of the activity priority (e.g., "HIGH", "MEDIUM")
     * @param project
     *            the project this priority belongs to
     */
    public CActivityPriority(final String name, final CProject project) {
        super(CActivityPriority.class, name, project);
        LOGGER.debug("CActivityPriority constructor called with name: {} and project: {}", name, project);
    }
     ...
     * 
     * @param name
     *            the name of the activity priority
     * @param project
     *            the project this priority belongs to
     * @param color
    ...
    public CActivityPriority(final String name, final CProject project, final String color, final Integer sortOrder) {
        ...
        LOGGER.debug("CActivityPriority constructor called with name: {}, project: {}, color: {}, sortOrder: {}", name,
