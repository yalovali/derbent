...
public class CActivityType extends CTypeEntity {
    ...
    @MetaData(displayName = "Type Name", required = true, readOnly = false, defaultValue = "-", description = "Name of the activity type", hidden = false)
    private String name;

    @Column(name = "description", nullable = true, length = MAX_LENGTH_DESCRIPTION)
    @Size(max = MAX_LENGTH_DESCRIPTION)
    @MetaData(displayName = "Description", required = false, readOnly = false, defaultValue = "", description = "Description of the activity type", hidden = false)
