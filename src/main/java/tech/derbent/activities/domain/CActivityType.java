...
/**
 * CActivityType - Domain entity representing activity types. Layer: Domain
 * (MVC) Inherits from CTypeEntity to provide type functionality for activities.
 */
@Entity
@Table(name = "cactivitytype")
@AttributeOverride(name = "id", column = @Column(name = "cactivitytype_id")) // Override the default column name for the ID field to follow classname_id
																				// convention
