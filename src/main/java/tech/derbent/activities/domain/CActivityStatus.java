...
public class CActivityStatus extends CTypeEntity {
    ...
    @MetaData(
        ...
        readOnly = false,
        defaultValue = "", 
        description = "Description of the activity status", 
        hidden = false,
        order = 2, 
    ...
    @MetaData(
        ...
        readOnly = false,
        defaultValue = "100", 
        description = "Display order for status sorting", 
        hidden = false,
        order = 5
    )
    ...
    public CActivityStatus(final String name) {
        super();
        logger.debug("CActivityStatus(name={}) - Creating activity status with name", name);
        if (name == null) {
    ...
    public CActivityStatus(final String name, final String description) {
        super();
        logger.debug("CActivityStatus(name={}, description={}) - Creating activity status with name and description", 
            name, description);
        if (name == null) {
     ...
     */
    public CActivityStatus(final String name, final String description, final String color, final boolean isFinal) {
        super();
        logger.debug("CActivityStatus(name={}, description={}, color={}, isFinal={}) - Creating full activity status", 
     ...
     * @param color the hex color code (e.g., "#FF0000") - if null or empty, defaults to gray
     */
    public void setColor(final String color) {
        logger.debug("setColor(color={}) - Setting color for status id={}", color, getId());
    ...
    public void setDescription(final String description) {
        logger.debug("setDescription(description={}) - Setting description for status id={}", description, getId());
        this.description = description;
    }
    ...
    public void setFinal(final boolean isFinal) {
        logger.debug("setFinal(isFinal={}) - Setting final flag for status id={}", isFinal, getId());
        this.isFinal = isFinal;
    }
    ...
    public void setName(final String name) {
        ...
        if (name == null) {
            logger.warn("setName(name=null) - Attempting to set null name for status id={}", getId());
        }
        this.name = name;
    }
     ...
     * @param sortOrder the sort order (higher numbers appear later) - if null, defaults to 100
     */
    public void setSortOrder(final Integer sortOrder) {
        logger.debug("setSortOrder(sortOrder={}) - Setting sort order for status id={}", sortOrder, getId());
