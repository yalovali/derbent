...
public class CActivityStatusInitializerService extends CInitializerServiceBase {
	...
	public static void initialize(final CProject project, final CGridEntityService gridEntityService,
		...
		initBase(clazz, project, gridEntityService, detailSectionService, pageEntityService, detailSection, grid, "Types.Activity Statuses",
				"Activity Status Management", "Manage activity status definitions for projects", showInQuickToolbar);
	}
}
