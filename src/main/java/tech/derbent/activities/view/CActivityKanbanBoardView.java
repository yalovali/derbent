...
@Menu(order = 1, icon = "vaadin:dashboard", title = "Activity.Kanban")
@PermitAll
public class CActivityKanbanBoardView extends VerticalLayout implements CProjectChangeListener {
     ...
     */
    public CActivityKanbanBoardView(final CActivityService activityService, final SessionService sessionService) {
