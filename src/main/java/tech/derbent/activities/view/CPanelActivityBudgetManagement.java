...
/**
 * CPanelActivityBudgetManagement - Panel for grouping budget management related fields of CActivity entity. Layer: View
 * (MVC) Groups fields: estimatedCost, actualCost, hourlyRate
 */
