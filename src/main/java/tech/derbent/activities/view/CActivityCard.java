...
/**
 * CActivityCard - UI component representing a single activity card in the Kanban board. Layer: View (MVC) Displays
 * activity information including name, description/summary, and status. Used within CActivityKanbanColumn to represent
...
public class CActivityCard extends Div {
     ...
     * 
     * @param activity
     *            the activity to display in the card
     */
    public CActivityCard(final CActivity activity) {
        LOGGER.debug("Creating CActivityCard for activity: {}", activity != null ? activity.getName() : "null");
