...
/**
 * CRiskStatusService - Service class for managing CRiskStatus entities. Layer: Service (MVC) Provides business
 * logic for risk status management including CRUD operations, validation, and workflow management.
 */
@Service
@Transactional
public class CRiskStatusService extends CEntityOfProjectService<CRiskStatus> {
    ...
    private final CRiskStatusRepository riskStatusRepository;
