...
public class CRiskStatusView extends CProjectAwareMDPage<CRiskStatus> {
    ...
    private final String ENTITY_ROUTE_TEMPLATE_EDIT = "risk-statuses/%s/edit";

    /**
     * Constructor for CRiskStatusView.
     * 
     * @param entityService
     *            the service for risk status operations
    ...
    protected void createDetailsLayout() {
        ...
        try {
            final Div detailsLayout = CEntityFormBuilder.buildForm(CRiskStatus.class, getBinder());
            ...
            throw new RuntimeException("Failed to create details layout for risk status view", e);
        }
    }
