...
/**
 * CRiskView - View for managing project risks. Layer: View (MVC) Provides CRUD operations for risks using the
 * project-aware master-detail pattern.
 */
...
public class CRiskView extends CProjectAwareMDPage<CRisk> implements CInterfaceIconSet {
    ...
    public static String getIconFilename() {
        return CRisk.getIconFilename();
    }

    public CRiskView(final CRiskService entityService, final CSessionService sessionService) {
    ...
    protected void createDetailsLayout() {
        ...
        panel = new CPanelRiskBasicInfo(getCurrentEntity(), getBinder(), (CRiskService) entityService);
