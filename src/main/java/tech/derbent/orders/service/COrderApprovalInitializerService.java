...
public final class COrderApprovalInitializerService extends CInitializerServiceBase {
        ...
        public static CGridEntity createGridEntity(final CProject project) {
                ...
                grid.setSelectedFields(
                                "id,name,order,approvalStatus,approvalLevel,approver,approvalDate,isActive");
                return grid;
        }
        ...
        public static void initialize(final CProject project, final CGridEntityService gridEntityService,
                ...
                initBase(ENTITY_CLASS, project, gridEntityService, detailSectionService, pageEntityService, detailSection, grid,
                                "Orders.Approvals", "Order Approval Management",
                                "Track approvals and decision workflow for orders", showInQuickToolbar);
        }
}
