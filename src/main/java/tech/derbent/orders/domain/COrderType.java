...
/**
 * COrderType - Domain entity representing types of orders in the system. Layer: Domain
 * (MVC) Defines the various categories of orders that can be created in the system, such
 * as Service Orders, Purchase Orders, Maintenance Orders, etc. This entity follows the
 * CEntityOfProject pattern providing project-aware functionality with automatic name and
 * description fields.
 */
@Entity
