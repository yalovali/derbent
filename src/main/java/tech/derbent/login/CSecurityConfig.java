 ...
 * Configures database-based authentication using CLoginUser entities.
 * 
 * Security Flow:
 ...
 * 5. Spring Security calls CLoginUserService.loadUserByUsername()
 * 6. Password is verified using BCryptPasswordEncoder
 * 7. If successful, user is authenticated and granted access
 * 8. User roles determine what resources they can access
 */
@EnableWebSecurity
@Configuration
class CSecurityConfig extends VaadinWebSecurity {
	...
	/**
	 * Constructor injection of CLoginUserService.
	 * This service provides UserDetailsService implementation for database authentication.
	 */
	public CSecurityConfig(CLoginUserService loginUserService) {
	 ...
	 * Sets up the login view and delegates other security configuration to Vaadin.
	 * 
