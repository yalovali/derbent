...
public class CCustomLoginView extends Main implements BeforeEnterObserver {
	...
	private HorizontalLayout createHorizontalField(final String labelText,
	...
	private void setupForm() {
		...
		final HorizontalLayout usernameLayout =
			createHorizontalField("Username:", usernameField);
		final HorizontalLayout passwordLayout =
			createHorizontalField("Password:", passwordField);
		// Setup form fields
		setupFormFields();
		...
		formCard.add(headerlayout, subtitle, usernameLayout, passwordLayout, errorMessage,
			loginButton, passwordHint, buttonsLayout);
