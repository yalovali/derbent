...
public class CLoginView extends Main implements BeforeEnterObserver {
	...
	public CLoginView() {
		...
		final CButton resetDbButton = new CButton("Reset Database", null, event -> {
		...
		final RouterLink customLoginLink =
			new RouterLink("Try Custom Login", CCustomLoginView.class);
