...
/**
 * Custom authentication success handler that manages post-login navigation.
 * 
 * This handler processes the redirect parameter from the login form or retrieves
 * the originally requested URL before login redirect, then navigates the user
...
public class CAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    /**
     * Determines the target URL for post-login redirection.
     * Priority order:
    ...
    /**
     * Maps view names from the combobox to actual URLs.
     * This should match the mapping used in CCustomLoginView.
     */
    ...
    /**
     * Stores the originally requested URL in the session.
     * This method should be called when a user is redirected to login.
     */
    ...
    /**
     * Determines if a URL should be saved as the requested URL.
     * Excludes login pages, static resources, etc.
     */
