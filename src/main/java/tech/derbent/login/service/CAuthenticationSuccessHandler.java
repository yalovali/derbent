...
public class CAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
	...
	/** Stores the authenticated user's login context (username and selected company) in the HTTP session. This information is later consumed by the
	 * Vaadin UI to initialize the session-scoped services.
